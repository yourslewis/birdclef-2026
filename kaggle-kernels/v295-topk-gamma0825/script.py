#!/usr/bin/env python3
"""
BirdCLEF 2026 - v295 Top-k Contrast + Gamma 0.825 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus combined strong row-wise top-k confidence contrast and gamma 0.825 power scaling.
"""
...
print('V295: v245 smoothing + strong top-k confidence contrast + gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v295 keeps the known-strong v111/v118 family of settings, especially:
...
# v295 post-processing: midpoint between v294 gamma 0.80 and the original
# v245/v256 gamma 0.85 while keeping the strong v256 top-k contrast.
# This tests whether mild probability spreading plus top-k contrast is better
# than either lower gamma 0.80 or the original gamma 0.85.
TOPK_CONTRAST_K = 5
...
# v295: row-wise top-k contrast after gamma scaling. Boost only the few
# strongest labels per row and gently damp the rest, preserving row-local rank.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast')
