#!/usr/bin/env python3
"""
BirdCLEF 2026 - v506 SED Local Logit Event Top5 Alpha0.025 + Context 0.25 Kernel
=============================================================================
...
print('V506: SED local logit-event boost top5 alpha0.025 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v506 keeps the known-strong v111/v118 family of settings, especially:
...
# v506: SED-inspired local event propagation in logit space. Top BirdCLEF
# 2025 systems used frame-local SED models; v506 keeps the broader top-5
# local event set from v506 but halves alpha to reduce local propagation risk
# while preserving a small SED-style temporal consistency signal.
LOCAL_EVENT_ALPHA = 0.025
LOCAL_EVENT_TOPK = 5
...
print(f'  Post: immediate temporal smooth, top5 logit local-event boost alpha0.025, sigmoid, file-context alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
