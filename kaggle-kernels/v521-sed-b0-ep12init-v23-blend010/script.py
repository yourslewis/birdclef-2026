...
REAL_SED_ZIP_NAME = 'sed-b0-q3cap80-ep12init-v23-bundle-v1.zip'
REAL_SED_DATASET_SLUG = 'bc26-sed-b0-ep12init-v23-bundle-v1'
...
def _sed_find_manifest():
    candidates = [
        ...
        Path('/kaggle/input') / REAL_SED_DATASET_SLUG / 'sed-b0-q3cap80-ep12init-v23-bundle-v1' / 'sed_bundle_manifest.json',
...
print(f'  Post: v508 immediate temporal/logit local-event axis + stronger real SED B0 ep12-init v23 bundle blend weight 0.10')
