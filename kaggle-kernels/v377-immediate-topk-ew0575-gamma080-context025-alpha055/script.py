#!/usr/bin/env python3
"""
BirdCLEF 2026 - v377 Immediate Top-k + EW0.575 + Gamma 0.80 + Context 0.25 + Alpha 0.55 Kernel
=============================================================================
...
print('V377: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.80 + context 0.25 + quantile alpha 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v377 keeps the known-strong v111/v118 family of settings, especially:
...
# v377 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and alpha0.55 fixed while shifting power gamma to 0.80 to test
# whether gentler confidence scaling improves macro-AUC recall.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 gamma0.80 context0.25 alpha0.55)')
