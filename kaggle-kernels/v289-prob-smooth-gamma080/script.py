#!/usr/bin/env python3
"""
BirdCLEF 2026 — v289 Probability Smooth + Gamma 0.80 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and lower power gamma 0.80.
"""
...
print('V289: probability temporal smoothing + power gamma 0.80')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v289 keeps the known-strong v111/v118 family of settings, especially:
...
# Smooth in probability space, then apply the v248 lower power-gamma calibration.
...
print(f'  Post: sigmoid → probability temporal smooth → file-context boost → gamma 0.80 power transform')
