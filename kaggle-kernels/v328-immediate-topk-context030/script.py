#!/usr/bin/env python3
"""
BirdCLEF 2026 - v328 Immediate Top-k + Strong File Context Kernel
=============================================================================
...
# v328 keeps the known-strong v111/v118 family of settings, especially:
...
# v328: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, strong file-context boost alpha 0.30, gamma 0.85, top-k contrast')
