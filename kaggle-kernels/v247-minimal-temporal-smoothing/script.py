#!/usr/bin/env python3
"""
BirdCLEF 2026 — v247 Minimal Temporal Smoothing Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus file-context boost and minimal temporal smoothing that mostly preserves the center 5-second window.
"""
...
print('V247: v238 + minimal temporal smoothing (center 0.90)')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v247 keeps the known-strong v111/v118 family of settings, especially:
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.0, 0.05, 0.90, 0.05, 0.0], dtype=np.float32)
POWER_GAMMA = 0.85
