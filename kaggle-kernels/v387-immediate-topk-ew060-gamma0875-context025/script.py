#!/usr/bin/env python3
"""
BirdCLEF 2026 - v387 Immediate Top-k + EW0.60 + Gamma 0.875 + Context 0.25 Kernel
=============================================================================
...
print('V387: immediate-only top-k + ProtoSSM EW0.60 + power gamma 0.875 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v387 keeps the known-strong v111/v118 family of settings, especially:
...
# v367 post-processing: midpoint the ProtoSSM blend between EW0.55 and
# EW0.675 while keeping the proven context0.25 axis, immediate-topk
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.60 gamma0.875 context0.25)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.875, top-k contrast, ProtoSSM EW0.60')
