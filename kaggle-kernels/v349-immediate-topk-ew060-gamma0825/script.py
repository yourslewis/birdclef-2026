#!/usr/bin/env python3
"""
BirdCLEF 2026 - v349 Immediate Top-k + EW0.60 + Gamma 0.825 Kernel
=============================================================================
...
print('V349: immediate-only top-k + ProtoSSM EW0.60 + power gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v349 keeps the known-strong v111/v118 family of settings, especially:
...
# v349 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.60 and pairing it with gamma=0.825;
# this tests whether a little more model-diversity weight helps without the EW0.50 slip.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast, ProtoSSM EW0.60')
