#!/usr/bin/env python3
"""
BirdCLEF 2026 — v288 Probability Smooth + Quantile 0.525 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and a slightly mean-heavier quantile mix.
"""
...
print('V288: probability temporal smoothing + quantile mix alpha 0.525')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v288 keeps the known-strong v111/v118 family of settings, especially:
...
# BirdCLEF writeups describe smoothing predictions/probabilities. v288 also
# leans quantile-mix slightly toward the simple/mean ensemble (alpha=0.525),
# pairing the v274 near-mid mean-heavy axis with v285 probability smoothing.
...
print(f'  Post: sigmoid → probability temporal smooth → file-context boost → power transform')
