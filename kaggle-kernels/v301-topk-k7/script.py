#!/usr/bin/env python3
"""
BirdCLEF 2026 - v301 Top-k Contrast K7 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus row-wise top-k confidence contrast on the top 7 labels.
"""
...
print('V301: v245 smoothing + top-k confidence contrast K=7')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v301 keeps the known-strong v111/v118 family of settings, especially:
...
# v301 post-processing: tune the "top n confident predictions" idea from
# BirdCLEF 2025 notes. v300 tests K=6 and v298 tests K=8; v301 tests
# the interior K=7 cutoff while keeping original gamma.
TOPK_CONTRAST_K = 7
...
# v301: row-wise top-k contrast after the original gamma scaling.
# Boost top 7 labels per row and gently damp the rest.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast K=7')
