#!/usr/bin/env python3
"""
BirdCLEF 2026 - v310 Immediate Top-k Mean-heavy Quantile Kernel
=============================================================================
...
# v310 keeps the known-strong v111/v118 family of settings, especially:
...
# v310 post-processing: combine two tied-best axes from v250/v255 with
# a subtle mean-heavy quantile mix. BirdCLEF 2025 writeups emphasized
# quantile/rank blending; this is the alpha 0.525 sibling of v309 alpha
# 0.475 for the immediate top-k variant.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, mean-heavy quantile mix alpha 0.525, file-context boost, gamma 0.85, top-k contrast')
