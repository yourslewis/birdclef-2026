#!/usr/bin/env python3
"""
BirdCLEF 2026 — v244 Strong Temporal Smoothing Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus file-context boost and stronger temporal smoothing across adjacent 5-second windows.
"""
...
print('V244: v238 + stronger Gaussian temporal smoothing')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v244 keeps the known-strong v111/v118 family of settings, especially:
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.15, 0.20, 0.30, 0.20, 0.15], dtype=np.float32)
POWER_GAMMA = 0.85
