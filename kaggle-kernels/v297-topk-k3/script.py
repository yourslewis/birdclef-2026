#!/usr/bin/env python3
"""
BirdCLEF 2026 - v297 Focused Top-k Contrast K3 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus focused row-wise top-k confidence contrast on the top 3 labels.
"""
...
print('V297: v245 smoothing + focused top-k confidence contrast K=3')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v297 keeps the known-strong v111/v118 family of settings, especially:
...
# v297 post-processing: tune the "top n confident predictions" idea from
# BirdCLEF 2025 notes. v255/v256 showed K=5 top-k contrast can retain 0.926;
# v297 makes the boost more selective with K=3 while keeping original gamma.
TOPK_CONTRAST_K = 3
...
# v297: focused row-wise top-k contrast after the original gamma scaling.
# Boost only top 3 labels per row and gently damp the rest.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, focused top-k contrast')
