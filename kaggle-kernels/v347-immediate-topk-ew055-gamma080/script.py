#!/usr/bin/env python3
"""
BirdCLEF 2026 - v347 Immediate Top-k + EW0.55 + Gamma 0.80 Kernel
=============================================================================
...
print('V347: immediate-only top-k + ProtoSSM EW0.55 + power gamma 0.80')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v347 keeps the known-strong v111/v118 family of settings, especially:
...
# v347 post-processing: keep the tied-best immediate top-k axis while
# combining ProtoSSM EW=0.55 from v263 with gamma=0.80 from v248;
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.80, top-k contrast, ProtoSSM EW0.55')
