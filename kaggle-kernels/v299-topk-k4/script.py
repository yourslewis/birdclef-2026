#!/usr/bin/env python3
"""
BirdCLEF 2026 - v299 Top-k Contrast K4 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus row-wise top-k confidence contrast on the top 4 labels.
"""
...
print('V299: v245 smoothing + top-k confidence contrast K=4')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v299 keeps the known-strong v111/v118 family of settings, especially:
...
# v299 post-processing: tune the "top n confident predictions" idea from
# BirdCLEF 2025 notes. v297 tested focused K=3 and v255/v256 used K=5;
# v299 tests the interior K=4 cutoff while keeping original gamma.
TOPK_CONTRAST_K = 4
...
# v299: row-wise top-k contrast after the original gamma scaling.
# Boost top 4 labels per row and gently damp the rest.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast K=4')
