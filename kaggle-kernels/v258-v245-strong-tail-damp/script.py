#!/usr/bin/env python3
"""
BirdCLEF 2026 — v258 v257 Smoothing + Tail Dampening Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and stronger row-wise low-rank tail dampening.
"""
...
print('V258: v245 smoothing + stronger low-rank tail dampening')
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.05, 0.10, 0.70, 0.10, 0.05], dtype=np.float32)
POWER_GAMMA = 0.85
...
# v258: row-wise low-rank tail dampening. Keep top-K class probabilities per
