#!/usr/bin/env python3
"""
BirdCLEF 2026 - v370 Immediate Top-k + EW0.575 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V370: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v370 keeps the known-strong v111/v118 family of settings, especially:
...
# v370 post-processing: lower-midpoint the ProtoSSM blend between EW0.55
# and EW0.60 while keeping the proven context0.25 axis, immediate-topk
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 context0.25)')
