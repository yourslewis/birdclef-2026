...
print(f'  Taxon max gate: floor={TAXON_MAX_GATE_FLOOR}, alpha={TAXON_MAX_GATE_ALPHA}')
print(f'  Post: immediate temporal smooth, top3 logit local-event boost, sigmoid, file-context alpha 0.275, gamma 0.825, top-k contrast, taxon max gate floor0.40 alpha0.75, ProtoSSM EW0.625')
