#!/usr/bin/env python3
"""
BirdCLEF 2026 - v300 Top-k Contrast K6 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus row-wise top-k confidence contrast on the top 6 labels.
"""
...
print('V300: v245 smoothing + top-k confidence contrast K=6')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v300 keeps the known-strong v111/v118 family of settings, especially:
...
# v300 post-processing: tune the "top n confident predictions" idea from
# BirdCLEF 2025 notes. v255/v256 used K=5 and v298 tests K=8; v300 tests
# the slightly broader K=6 cutoff while keeping original gamma.
TOPK_CONTRAST_K = 6
...
# v300: row-wise top-k contrast after the original gamma scaling.
# Boost top 6 labels per row and gently damp the rest.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast K=6')
