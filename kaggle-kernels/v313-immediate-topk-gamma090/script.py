#!/usr/bin/env python3
"""
BirdCLEF 2026 - v313 Immediate Top-k Gamma 0.90 Kernel
=============================================================================
...
# v313 keeps the known-strong v111/v118 family of settings, especially:
...
# v313 post-processing: combine immediate-only temporal smoothing and light
# top-k contrast with gamma 0.90. v249 gamma 0.90 tied best on the v245
# smoothing axis, and BirdCLEF 2025 writeups emphasize power adjustment;
# this tests whether milder sharpening is complementary on immediate top-k.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.90, top-k contrast')
