#!/usr/bin/env python3
"""
BirdCLEF 2026 — v290 Probability Smooth + Gamma 0.90 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and higher power gamma 0.90.
"""
...
print('V290: probability temporal smoothing + power gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v290 keeps the known-strong v111/v118 family of settings, especially:
...
# Smooth in probability space, then apply the v249 higher power-gamma calibration.
# BirdCLEF writeups cite both prediction smoothing and power scaling as useful
# AUC post-processing levers.
...
print(f'  Post: sigmoid → probability temporal smooth → file-context boost → gamma 0.90 power transform')
