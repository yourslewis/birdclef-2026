#!/usr/bin/env python3
"""
BirdCLEF 2026 - v507 SED Local Logit Event Top3 EW0.60 + Context 0.25 Kernel
=============================================================================
...
print('V507: SED local logit-event boost top3 + ProtoSSM EW0.60 + gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v507 keeps the known-strong v111/v118 family of settings, especially:
...
# v507: SED-inspired local event propagation in logit space. Top BirdCLEF
# 2025 systems used frame-local SED models; v507 keeps v507 top-3 logit
# local events but lowers ProtoSSM EW to 0.60, matching the v367 tied-best
# ensemble balance.
...
print(f'  Post: immediate temporal smooth, top3 logit local-event boost, sigmoid, file-context alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.60')
