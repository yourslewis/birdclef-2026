#!/usr/bin/env python3
"""
BirdCLEF 2026 - v383 Immediate Top-k + EW0.575 + Gamma 0.90 + Context 0.25 + Alpha 0.45 Kernel
=============================================================================
...
print('V383: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.90 + context 0.25 + quantile alpha 0.45')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v383 keeps the known-strong v111/v118 family of settings, especially:
...
# v383 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and power gamma0.90 fixed while shifting Quantile-Mix to rank-heavy
# alpha0.45 to test whether rank averaging helps this sharper axis.
TOPK_CONTRAST_K = 5
...
print(f'  Ensemble: rank-heavy quantile-mix ({QUANTILE_MIX_ALPHA} simple + {1-QUANTILE_MIX_ALPHA} rank-avg)')
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 gamma0.90 context0.25 alpha0.45)')
