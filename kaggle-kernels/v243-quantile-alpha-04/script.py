#!/usr/bin/env python3
"""
BirdCLEF 2026 — v243 Quantile Mix Alpha 0.40 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus file-context boost and a slightly higher quantile-mix weight on rank averaging (alpha 0.40).
"""
...
print('V243: v238 + quantile mix alpha 0.40')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v243 keeps the known-strong v111/v118 family of settings, especially:
