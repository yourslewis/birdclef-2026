#!/usr/bin/env python3
"""
BirdCLEF 2026 - v309 Immediate Top-k Rank-heavy Quantile Kernel
=============================================================================
...
# v309 keeps the known-strong v111/v118 family of settings, especially:
...
# v309 post-processing: combine two tied-best axes from v250/v255 with
# a subtle rank-heavy quantile mix. BirdCLEF 2025 writeups emphasized
# quantile/rank blending; this tests whether alpha 0.475 helps the
# immediate top-k variant without a large departure from alpha 0.5.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, rank-heavy quantile mix alpha 0.475, file-context boost, gamma 0.85, top-k contrast')
