#!/usr/bin/env python3
"""
BirdCLEF 2026 - v350 Immediate Top-k + EW0.60 + Gamma 0.875 Kernel
=============================================================================
...
print('V350: immediate-only top-k + ProtoSSM EW0.60 + power gamma 0.875')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v350 keeps the known-strong v111/v118 family of settings, especially:
...
# v350 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.60 and pairing it with gamma=0.875;
# this tests whether the stronger diversity blend prefers a sharper power shape.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.875, top-k contrast, ProtoSSM EW0.60')
