#!/usr/bin/env python3
"""
BirdCLEF 2026 — v272 Immediate Temporal + Quantile Alpha 0.55 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing and a slight Quantile-Mix shift toward simple averaging.
"""
...
print('V272: immediate-only temporal smoothing + quantile mix alpha 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v272 keeps the known-strong v111/v118 family of settings, especially:
