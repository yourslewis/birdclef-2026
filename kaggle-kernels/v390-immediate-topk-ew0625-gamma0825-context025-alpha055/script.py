#!/usr/bin/env python3
"""
BirdCLEF 2026 - v390 Immediate Top-k + EW0.625 + Gamma 0.825 + Context 0.25 + Alpha 0.55 Kernel
=============================================================================
...
print('V390: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.825 + context 0.25 + quantile alpha 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v390 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.625 context0.25 alpha0.55)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, quantile alpha 0.55, top-k contrast, ProtoSSM EW0.625')
