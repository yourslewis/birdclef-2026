#!/usr/bin/env python3
"""
BirdCLEF 2026 - v339 Immediate Top-k + ProtoSSM Weight 0.575 Kernel
=============================================================================
...
print('V339: immediate-only temporal smoothing + top-k contrast + ProtoSSM ensemble weight 0.575')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v339 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.575 (v339 slightly lower SED/temporal member weighting)
...
# v339 post-processing: keep the tied-best immediate top-k axis while
# testing a slightly lower ProtoSSM temporal member. v263 EW=0.55 tied
# best on the v245 axis while v264 EW=0.50 slipped, so 0.575 is a
# conservative midpoint below the 0.60 baseline.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM weight 0.575')
