#!/usr/bin/env python3
"""
BirdCLEF 2026 — v195: Tuned Post-Processing
=============================================================================

Based on v111 with mathematically derived optimal hyper-parameters.
The exact scalar values were calculated via coordinate descent OOF grid search
in notebook v193 on Kaggle:

OPTIMAL PARAMS:
- PROBE_ALPHA: 0.5 (was 0.4)
- PROTOSSM_ENSEMBLE_WEIGHT: 0.6 (was 0.5)
- QUANTILE_MIX_ALPHA: 0.3 (was 0.5)
- SHARP_TEMP: 0.5 (was 0.7)
- POWER_GAMMA: 0.85 (unchanged)
- FILE_CONTEXT_ALPHA: 0.2 (was 0.15)
"""
...
PROBE_MIN_POS = 8
PROBE_C = 0.50
PROBE_ALPHA = 0.50  # Tuned in v193 (was 0.40)

# ProtoSSM params — v90: restore 3 seeds for robustness (like v67)
PROTOSSM_ENSEMBLE_WEIGHT = 0.60  # Tuned in v193 (was 0.50)
...
POWER_GAMMA = 0.85  # Tuned in v193 (was 0.85)
FILE_CONTEXT_ALPHA = 0.20  # Tuned in v193 (was 0.15)
QUANTILE_MIX_ALPHA = 0.30  # Tuned in v193 (was 0.50)
...
for idx in SHARPENED:
    PER_CLASS_TEMPS[idx] = 0.5  # Tuned in v193 (was 0.7)
PER_CLASS_TEMPS[18] = 0.6       # Tuned in v193 (was 0.8)
