#!/usr/bin/env python3
"""
BirdCLEF 2026 — v246 Ultra-Sharp Temporal Smoothing Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus file-context boost and ultra-sharp temporal smoothing that further preserves the center 5-second window.
"""
...
print('V246: v238 + ultra-sharp Gaussian temporal smoothing')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v246 keeps the known-strong v111/v118 family of settings, especially:
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.025, 0.075, 0.80, 0.075, 0.025], dtype=np.float32)
POWER_GAMMA = 0.85
