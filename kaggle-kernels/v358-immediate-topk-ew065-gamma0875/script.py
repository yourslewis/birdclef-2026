#!/usr/bin/env python3
"""
BirdCLEF 2026 - v358 Immediate Top-k + EW0.65 + Gamma 0.875 Kernel
=============================================================================
...
print('V358: immediate-only top-k + ProtoSSM EW0.65 + power gamma 0.875')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v358 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v345 lower SED/temporal member weighting)
# - Power gamma = 0.875 (v265 tied-best upper-mid gamma)
...
# v358 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.65 and pairing it with gamma=0.875;
# this tests whether the EW0.65 diversity step prefers sharper upper-mid confidence shaping.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.875, top-k contrast, ProtoSSM EW0.65')
