#!/usr/bin/env python3
"""
BirdCLEF 2026 - v371 Immediate Top-k + EW0.575 + Gamma 0.80 + Context 0.25 Kernel
=============================================================================
...
print('V371: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.80 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v371 keeps the known-strong v111/v118 family of settings, especially:
...
# v371 post-processing: keep the lower-midpoint EW0.575 and proven
# context0.25 axis, but test softer power gamma0.80 after the base
# gamma0.80 axis tied best and may interact with stronger context.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 context0.25 gamma0.80)')
