#!/usr/bin/env python3
"""
BirdCLEF 2026 - v341 Immediate Top-k + ProtoSSM Weight 0.65 Kernel
=============================================================================
...
print('V341: immediate-only temporal smoothing + top-k contrast + ProtoSSM ensemble weight 0.65')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v341 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.65 (v341 higher SED/temporal member weighting)
...
# v341 post-processing: keep the tied-best immediate top-k axis while
# testing a higher ProtoSSM temporal member weight. BirdCLEF 2025
# solutions emphasize SED/model-diverse ensembles, so this brackets
# the high side beyond v338 EW=0.625.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM weight 0.65')
