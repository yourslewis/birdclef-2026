#!/usr/bin/env python3
"""
BirdCLEF 2026 - v323 Immediate Temporal + Top-k K7 Kernel
=============================================================================
...
# v323 keeps the known-strong v111/v118 family of settings, especially:
...
# v323: row-wise top-k contrast after immediate-only smoothing and original
# gamma scaling. Boost top 7 labels per row and gently damp the rest.
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, broader top-k contrast K7')
