#!/usr/bin/env python3
"""
BirdCLEF 2026 — v242 Quantile Mix Alpha 0.60 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus file-context boost and a slightly higher quantile-mix weight on simple ensemble (alpha 0.60).
"""
...
print('V242: v238 + quantile mix alpha 0.60')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v242 keeps the known-strong v111/v118 family of settings, especially:
