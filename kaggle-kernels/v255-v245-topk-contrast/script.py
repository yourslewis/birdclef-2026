#!/usr/bin/env python3
"""
BirdCLEF 2026 — v255 v255 Smoothing + Light Top-K Contrast Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and light row-wise top-k confidence contrast.
"""
...
print('V255: v245 smoothing + light top-k confidence contrast')
...
# v255 post-processing: lightly emphasize each row's strongest candidates and
# dampen the rest. This retests the v240 top-k contrast idea on top of the
# stronger v245 temporal smoothing baseline.
TOPK_CONTRAST_K = 3
...
# v255: row-wise top-k contrast. Boost only the few strongest labels in each
