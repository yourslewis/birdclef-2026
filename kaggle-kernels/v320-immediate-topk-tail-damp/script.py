#!/usr/bin/env python3
"""
BirdCLEF 2026 - v320 Immediate Top-k + Tail Damp Kernel
=============================================================================
...
# v320: row-wise top-k contrast after immediate-only smoothing and original
...
# v320: deeper-tail dampening from v257. Keep the top 10 labels after
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, tail dampening')
