#!/usr/bin/env python3
"""
BirdCLEF 2026 — v276 Immediate Temporal + ProtoSSM EW 0.55 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing and a small ensemble-weight shift toward the class-probe branch.
"""
...
print('V276: immediate-only temporal smoothing + ProtoSSM ensemble weight 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v276 keeps the known-strong v111/v118 family of settings, especially:
