#!/usr/bin/env python3
"""
BirdCLEF 2026 - v311 Immediate Top-k Rank-heavy Quantile 0.45 Kernel
=============================================================================
...
# v311 keeps the known-strong v111/v118 family of settings, especially:
...
# v311 post-processing: combine two tied-best axes from v250/v255 with
# a stronger rank-heavy quantile mix. BirdCLEF 2025 writeups emphasized
# Quantile-Mix / rank blending; this extends v309 alpha 0.475 toward the
# previously explored alpha 0.45 setting on the immediate top-k variant.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, rank-heavy quantile mix alpha 0.45, file-context boost, gamma 0.85, top-k contrast')
