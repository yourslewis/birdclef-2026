#!/usr/bin/env python3
"""
BirdCLEF 2026 — v241 Stronger Top-K Contrast Kernel
=============================================================================
...
print('V241: v240 + stronger top-k confidence contrast post-processing')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v241 keeps the known-strong v111/v118 family of settings, especially:
