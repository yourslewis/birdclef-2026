#!/usr/bin/env python3
"""
BirdCLEF 2026 - v402 Immediate No Top-k + EW0.625 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V402: immediate-only no top-k contrast + ProtoSSM EW0.625 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v402 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.625 context0.25 noTopK)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, no top-k contrast, ProtoSSM EW0.625')
