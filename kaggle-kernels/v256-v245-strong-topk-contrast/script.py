#!/usr/bin/env python3
"""
BirdCLEF 2026 — v256 v255 Smoothing + Light Top-K Contrast Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and stronger row-wise top-k confidence contrast.
"""
...
print('V256: v245 smoothing + stronger top-k confidence contrast')
...
# v256 post-processing: stronger row-wise top-k contrast. This retests the
# v241 stronger top-k setting on top of the stronger v245 temporal smoothing
# baseline.
TOPK_CONTRAST_K = 5
...
# v256: row-wise top-k contrast. Boost only the few strongest labels in each
