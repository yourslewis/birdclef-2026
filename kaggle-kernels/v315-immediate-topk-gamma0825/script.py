#!/usr/bin/env python3
"""
BirdCLEF 2026 - v315 Immediate Top-k Gamma 0.825 Kernel
=============================================================================
...
# v315 keeps the known-strong v111/v118 family of settings, especially:
...
# v315 post-processing: combine immediate-only temporal smoothing and light
# top-k contrast with gamma 0.825. BirdCLEF 2025 writeups emphasize power
# adjustment; v314 tests gamma 0.80 and v305 uses 0.85, so this samples
# the lower midpoint on the immediate top-k axis.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast')
