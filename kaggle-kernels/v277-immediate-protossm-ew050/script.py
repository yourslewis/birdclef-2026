#!/usr/bin/env python3
"""
BirdCLEF 2026 — v277 Immediate Temporal + ProtoSSM EW 0.50 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing and a balanced class-probe / ProtoSSM ensemble weight.
"""
...
print('V277: immediate-only temporal smoothing + ProtoSSM ensemble weight 0.50')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v277 keeps the known-strong v111/v118 family of settings, especially:
