#!/usr/bin/env python3
"""
BirdCLEF 2026 - v384 Immediate Top-k + EW0.625 + Gamma 0.80 + Context 0.25 Kernel
=============================================================================
...
print('V384: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.80 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v384 keeps the known-strong v111/v118 family of settings, especially:
...
# v384 post-processing: keep the freshly tied-best EW0.625/context0.25
# axis while shifting power gamma to 0.80 to test whether gentler
# confidence scaling improves macro-AUC.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.625 gamma0.80 context0.25)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.80, top-k contrast, ProtoSSM EW0.625')
