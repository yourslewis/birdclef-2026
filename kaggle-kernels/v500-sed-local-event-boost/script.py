#!/usr/bin/env python3
"""
BirdCLEF 2026 - v500 SED-inspired Local Event Boost Kernel
=============================================================================
...
print('V500: SED-inspired local event boost + ProtoSSM EW0.625 + gamma 0.825 + context 0.20')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v500 keeps the known-strong v111/v118 family of settings, especially:
...
# v500: SED-inspired local event propagation. Top BirdCLEF 2025 systems used
# SED/frame-local event models; this approximates that at inference-time by
# letting high-confidence events persist to neighboring 5s windows, while using
# a slightly lower global file-context alpha to avoid whole-file false positives.
LOCAL_EVENT_ALPHA = 0.15
LOCAL_EVENT_TOPK = 8
...
print(f'  Post: immediate temporal smooth, sigmoid, local-event boost, file-context alpha 0.20, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
