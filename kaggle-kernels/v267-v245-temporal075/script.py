#!/usr/bin/env python3
"""
BirdCLEF 2026 — v267 v267 Intermediate Temporal 0.75 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus an intermediate center-preserving temporal smoothing point between v245 and v246.
"""
...
print('V267: v245 family + intermediate Gaussian temporal smoothing center 0.75')
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.025, 0.10, 0.75, 0.10, 0.025], dtype=np.float32)
POWER_GAMMA = 0.85
