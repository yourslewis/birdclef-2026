#!/usr/bin/env python3
"""
BirdCLEF 2026 - v308 Immediate Temporal + Stronger Top-k Contrast Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-only temporal smoothing combined with stronger top-5 confidence contrast.
"""
...
print('V308: immediate-only temporal smoothing + stronger top-k contrast K=5 p0.85/1.15')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v308 keeps the known-strong v111/v118 family of settings, especially:
...
# v308 post-processing: combine v250 immediate-only temporal smoothing with
# v302 stronger K=5 boost+damp contrast. This tests the full stronger
# confidence-separation transform on the immediate smoothing axis.
TOPK_CONTRAST_K = 5
...
# v308: stronger row-wise top-k contrast after immediate-only smoothing and
# original gamma scaling. Boost top 5 labels and damp non-top labels.
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, stronger top-k contrast')
