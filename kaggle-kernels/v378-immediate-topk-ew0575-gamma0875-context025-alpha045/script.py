#!/usr/bin/env python3
"""
BirdCLEF 2026 - v378 Immediate Top-k + EW0.575 + Gamma 0.875 + Context 0.25 + Alpha 0.45 Kernel
=============================================================================
...
print('V378: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.875 + context 0.25 + quantile alpha 0.45')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v378 keeps the known-strong v111/v118 family of settings, especially:
...
QUANTILE_MIX_ALPHA = 0.45

# v378 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and alpha0.45 fixed while shifting power gamma to 0.875 to test
# whether sharper confidence scaling helps rank-heavy macro-AUC.
TOPK_CONTRAST_K = 5
...
print(f'  Ensemble: stronger rank-heavy quantile-mix ({QUANTILE_MIX_ALPHA} simple + {1-QUANTILE_MIX_ALPHA} rank-avg)')
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 gamma0.875 context0.25 alpha0.45)')
