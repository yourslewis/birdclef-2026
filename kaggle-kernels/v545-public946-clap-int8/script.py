...
# final blend uses only 5% CLAP rank weight.  Missing/failed CLAP is a hard failure
...
# 
# This final step computes a 3-way rank-based ensemble combining our sequence model (57%), the primary distilled SED branch (38%), and the v545 CLAP INT8 side stream (5%). 
# 
...
print("Executing v545 3-way rank blend (57% Proto / 38% SED / 5% CLAP INT8)...")
pred = (rank_proto * 0.57) + (rank_sed * 0.38) + (rank_clap * 0.05)
