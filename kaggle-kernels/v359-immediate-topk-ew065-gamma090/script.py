#!/usr/bin/env python3
"""
BirdCLEF 2026 - v359 Immediate Top-k + EW0.65 + Gamma 0.90 Kernel
=============================================================================
...
print('V359: immediate-only top-k + ProtoSSM EW0.65 + power gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v359 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v345 lower SED/temporal member weighting)
# - Power gamma = 0.90 (v249 tied-best sharper gamma)
...
# v359 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.65 and pairing it with gamma=0.90;
# this completes the sharper endpoint of the EW0.65 gamma bracket.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.90, top-k contrast, ProtoSSM EW0.65')
