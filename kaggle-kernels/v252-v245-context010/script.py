#!/usr/bin/env python3
"""
BirdCLEF 2026 — v252 v245 Smoothing + Context 0.10 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and lighter within-file context boost (alpha 0.10).
"""
...
print('V252: v245 smoothing + file context alpha 0.10')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v252 keeps the known-strong v111/v118 family of settings, especially:
