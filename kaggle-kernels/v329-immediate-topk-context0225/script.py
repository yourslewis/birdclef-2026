#!/usr/bin/env python3
"""
BirdCLEF 2026 - v329 Immediate Top-k + Context 0.225 Kernel
=============================================================================
...
# v329 keeps the known-strong v111/v118 family of settings, especially:
...
# v329: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.225, gamma 0.85, top-k contrast')
