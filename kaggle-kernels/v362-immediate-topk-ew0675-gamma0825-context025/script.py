#!/usr/bin/env python3
"""
BirdCLEF 2026 - v362 Immediate Top-k + EW0.675 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V362: immediate-only top-k + ProtoSSM EW0.675 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v362 keeps the known-strong v111/v118 family of settings, especially:
...
# v362 post-processing: keep the tied-best immediate top-k/protossm/gamma axis while
# lifting file context alpha to 0.25 after v268 set a new best;
# this tests whether the new context signal transfers to the richer immediate-topk family.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (v268-inspired)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.675')
