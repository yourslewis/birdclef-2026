#!/usr/bin/env python3
"""
BirdCLEF 2026 v554 public946 gate-retune dry-run candidate.
...
print("Executing v554 gate-retune rank blend (56% Proto / 44% SED)...")
...
print(f"v554 gate retune params: proto_weight={V554_PROTO_WEIGHT}, fake_boost={V554_FAKE_BOOST}, ctx_thr={V554_CTX_THR}, ctx_boost={V554_CTX_BOOST}, sed_rank_thr={V554_SED_RANK_THR}, sed_boost={V554_SED_BOOST}, rare_scale={V554_RARE_SCALE}")
print("v554 blend and post-processing complete. Ready for gated dry-run review!")
