#!/usr/bin/env python3
"""
BirdCLEF 2026 - v374 Immediate Top-k + EW0.575 + Gamma 0.825 + Context 0.25 + Alpha 0.525 Kernel
=============================================================================
...
print('V374: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.825 + context 0.25 + quantile alpha 0.525')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v374 keeps the known-strong v111/v118 family of settings, especially:
...
QUANTILE_MIX_ALPHA = 0.525

# v374 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and gamma0.825 fixed while shifting Quantile-Mix slightly mean-heavy
# at alpha0.525 to test mean/rank blend sensitivity.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 context0.25 alpha0.525)')
