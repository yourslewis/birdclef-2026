#!/usr/bin/env python3
"""
BirdCLEF 2026 - v340 Immediate Top-k + ProtoSSM Weight 0.55 Kernel
=============================================================================
...
print('V340: immediate-only temporal smoothing + top-k contrast + ProtoSSM ensemble weight 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v340 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v340 lower SED/temporal member weighting)
...
# v340 post-processing: keep the tied-best immediate top-k axis while
# applying the lower ProtoSSM EW=0.55 that tied best on the v245 axis
# (v263=0.926), unlike EW=0.50 which slipped to 0.925.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM weight 0.55')
