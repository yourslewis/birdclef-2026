#!/usr/bin/env python3
"""
BirdCLEF 2026 - v330 Immediate Top-k + Context 0.175 Kernel
=============================================================================
...
# v330 keeps the known-strong v111/v118 family of settings, especially:
...
# v330: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.175, gamma 0.85, top-k contrast')
