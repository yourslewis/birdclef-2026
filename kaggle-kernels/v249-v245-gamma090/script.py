#!/usr/bin/env python3
"""
BirdCLEF 2026 — v249 v245 Smoothing + Gamma 0.90 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and slightly sharper power scaling (gamma 0.90).
"""
...
print('V249: v245 smoothing + power gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v249 keeps the known-strong v111/v118 family of settings, especially:
