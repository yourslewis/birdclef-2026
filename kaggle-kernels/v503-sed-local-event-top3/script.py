#!/usr/bin/env python3
"""
BirdCLEF 2026 - v503 SED Local Event Top3 + Context 0.25 Kernel
=============================================================================
...
print('V503: SED local event boost top3 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v503 keeps the known-strong v111/v118 family of settings, especially:
...
# v503: SED-inspired local event propagation. Top BirdCLEF 2025 systems used
# SED/frame-local event models; v503 keeps proven context0.25 but uses a
...
print(f'  Post: immediate temporal smooth, sigmoid, top3 local-event boost, file-context alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
