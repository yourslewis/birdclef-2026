#!/usr/bin/env python3
"""
BirdCLEF 2026 - v312 Immediate Top-k Mean-heavy Quantile 0.55 Kernel
=============================================================================
...
# v312 keeps the known-strong v111/v118 family of settings, especially:
...
# v312 post-processing: combine two tied-best axes from v250/v255 with
# a stronger mean-heavy quantile mix. BirdCLEF 2025 writeups emphasized
# Quantile-Mix / mean+rank blending; this is the alpha 0.55 sibling of
# v311 alpha 0.45 for the immediate top-k variant.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, mean-heavy quantile mix alpha 0.55, file-context boost, gamma 0.85, top-k contrast')
