#!/usr/bin/env python3
"""
BirdCLEF 2026 - v327 Immediate Top-k + Stronger File Context Kernel
=============================================================================
...
# v327 keeps the known-strong v111/v118 family of settings, especially:
...
# v327: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, stronger file-context boost alpha 0.25, gamma 0.85, top-k contrast')
