#!/usr/bin/env python3
"""
BirdCLEF 2026 - v298 Broad Top-k Contrast K8 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus broader row-wise top-k confidence contrast on the top 8 labels.
"""
...
print('V298: v245 smoothing + broad top-k confidence contrast K=8')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v298 keeps the known-strong v111/v118 family of settings, especially:
...
# v298 post-processing: tune the "top n confident predictions" idea from
# BirdCLEF 2025 notes. v255/v256 used K=5; v297 tests focused K=3;
# v298 tests broader K=8 to see if secondary co-occurring species benefit.
TOPK_CONTRAST_K = 8
...
# v298: broader row-wise top-k contrast after the original gamma scaling.
# Boost top 8 labels per row and gently damp the rest.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, broad top-k contrast')
