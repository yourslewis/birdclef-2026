#!/usr/bin/env python3
"""
BirdCLEF 2026 - v366 Immediate Top-k + EW0.55 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V366: immediate-only top-k + ProtoSSM EW0.55 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v366 keeps the known-strong v111/v118 family of settings, especially:
...
# v366 post-processing: combine the proven context0.25 axis with the
# empirically safer ProtoSSM EW0.55 setting while keeping immediate-topk
# smoothing and gamma0.825 fixed. This tests whether EW0.675 was too heavy.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.55 context0.25)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.55')
