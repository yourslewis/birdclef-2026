...
# v518: blend in a lightweight 5s EfficientNet-B0 pseudo-label student after
# existing v508 probability shaping. Local labeled-soundscape sweep favors a
# very small linear blend (0.02) because the student is strong but correlated.
...
REAL_SED_ZIP_NAME = 'bc26-student-b0-5s-v1.zip'
REAL_SED_DATASET_SLUG = 'bc26-student-b0-5s-v1'
...
# === Cell: v518 Student B0 5s bundle blend ===
...
print(f'  Post: v508 immediate temporal/logit local-event axis + 5s B0 pseudo-label student blend weight 0.02')
