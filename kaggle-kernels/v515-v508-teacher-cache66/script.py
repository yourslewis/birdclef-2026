...
print('V515: v508 teacher cache dry-run on 66 labeled train soundscapes; SED local logit-event boost top3 + ProtoSSM EW0.625 + gamma 0.825 + context 0.275')
...
print(f'  Post: immediate temporal smooth, top3 logit local-event boost, sigmoid, file-context alpha 0.275, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
