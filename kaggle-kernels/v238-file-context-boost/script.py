#!/usr/bin/env python3
"""
BirdCLEF 2026 — v238 File Context Boost Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus a slightly stronger within-file context boost (alpha 0.20).
"""
...
print('V238: v237 + stronger within-file context boost (alpha=0.20)')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v238 keeps the known-strong v111/v118 family of settings, especially:
