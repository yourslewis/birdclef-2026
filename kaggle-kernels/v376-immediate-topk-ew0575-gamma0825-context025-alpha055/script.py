#!/usr/bin/env python3
"""
BirdCLEF 2026 - v376 Immediate Top-k + EW0.575 + Gamma 0.825 + Context 0.25 + Alpha 0.55 Kernel
=============================================================================
...
print('V376: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.825 + context 0.25 + quantile alpha 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v376 keeps the known-strong v111/v118 family of settings, especially:
...
# v376 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and gamma0.825 fixed while extending Quantile-Mix mean-heavy
# at alpha0.55 to test whether simple averaging helps macro-AUC.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 context0.25 alpha0.55)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.575')
