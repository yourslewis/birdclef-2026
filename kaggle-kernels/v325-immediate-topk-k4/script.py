#!/usr/bin/env python3
"""
BirdCLEF 2026 - v325 Immediate Temporal + Top-k K4 Kernel
=============================================================================
...
# v325 keeps the known-strong v111/v118 family of settings, especially:
...
# v325: row-wise top-k contrast after immediate-only smoothing and original
# gamma scaling. Boost top 4 labels per row and gently damp the rest.
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, focused top-k contrast K4')
