#!/usr/bin/env python3
"""
BirdCLEF 2026 - v321 Immediate Top-k + Strong Tail Damp Kernel
=============================================================================
...
# v321 keeps the known-strong v111/v118 family of settings, especially:
...
# v321: additionally apply v258 safe/tied-best stronger low-rank tail
# dampening after the v305 immediate top-k contrast. This tests a more
# aggressive version of v320's combined top-k + deeper-tail calibration.
TAIL_KEEP_TOP_K = 5
TAIL_DAMP_POWER = 1.10
...
# v321: row-wise top-k confidence contrast after immediate-only smoothing
# and original gamma scaling. Boost top 5 labels per row and gently damp the rest.
...
# v321: stronger deeper-tail dampening from v258. Keep the top 5 labels after
# top-k contrast and suppress the remaining low-rank tail.
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, strong tail dampening')
