#!/usr/bin/env python3
"""
BirdCLEF 2026 - v348 Immediate Top-k + EW0.55 + Gamma 0.90 Kernel
=============================================================================
...
print('V348: immediate-only top-k + ProtoSSM EW0.55 + power gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v348 keeps the known-strong v111/v118 family of settings, especially:
...
# v348 post-processing: keep the tied-best immediate top-k axis while
# combining ProtoSSM EW=0.55 from v263 with gamma=0.90 from v249;
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.90, top-k contrast, ProtoSSM EW0.55')
