#!/usr/bin/env python3
"""
BirdCLEF 2026 - v294 Top-k Contrast + Gamma 0.80 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus combined strong row-wise top-k confidence contrast and gamma 0.80 power scaling.
"""
...
print('V294: v245 smoothing + strong top-k confidence contrast + gamma 0.80')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v294 keeps the known-strong v111/v118 family of settings, especially:
...
# v294 post-processing: combine v256 strong top-k contrast with the softer
# tied-best v248 gamma 0.80 power scaling. This is the lower-gamma sibling of
# v293 and tests whether more probability spreading helps the top-k contrast.
TOPK_CONTRAST_K = 5
...
# v294: row-wise top-k contrast after gamma scaling. Boost only the few
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.80, top-k contrast')
