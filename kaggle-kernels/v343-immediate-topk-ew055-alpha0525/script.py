#!/usr/bin/env python3
"""
BirdCLEF 2026 - v343 Immediate Top-k + EW0.55 + Quantile Alpha 0.525 Kernel
=============================================================================
...
print('V343: immediate-only top-k + ProtoSSM EW0.55 + quantile alpha 0.525')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v343 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v343 lower SED/temporal member weighting)
# - Quantile-Mix alpha = 0.525 (v262 tied-best mean-heavier blend)
...
# v343 post-processing: keep the tied-best immediate top-k axis while
# combining two tied-safe signals: ProtoSSM EW=0.55 from v263 and
# mean-heavier Quantile-Mix alpha=0.525 from v262.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM EW0.55, quantile alpha 0.525')
