#!/usr/bin/env python3
"""
BirdCLEF 2026 - v346 Immediate Top-k + EW0.55 + Gamma 0.875 Kernel
=============================================================================
...
print('V346: immediate-only top-k + ProtoSSM EW0.55 + power gamma 0.875')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v346 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v345 lower SED/temporal member weighting)
# - Power gamma = 0.875 (v265 tied-best gentler-sharpening gamma)
...
# v346 post-processing: keep the tied-best immediate top-k axis while
# combining ProtoSSM EW=0.55 from v263 with gamma=0.875 from v265;
# both tied best on the v245 axis.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.875, top-k contrast, ProtoSSM EW0.55')
