#!/usr/bin/env python3
"""
BirdCLEF 2026 — v251 v245 Smoothing + Context 0.15 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing and gentler within-file context boost (alpha 0.15).
"""
...
print('V251: v245 smoothing + file context alpha 0.15')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v251 keeps the known-strong v111/v118 family of settings, especially:
