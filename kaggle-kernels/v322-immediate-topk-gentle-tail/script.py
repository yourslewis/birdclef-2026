#!/usr/bin/env python3
"""
BirdCLEF 2026 - v322 Immediate Top-k + Gentle Tail Damp Kernel
=============================================================================
...
# v322 keeps the known-strong v111/v118 family of settings, especially:
...
# v322: additionally apply v259 safe/tied-best gentle low-rank tail dampening
# after the v305 immediate top-k contrast. This is the softest combined
# top-k + deeper-tail calibration variant.
TAIL_KEEP_TOP_K = 20
TAIL_DAMP_POWER = 1.03
...
# v322: row-wise top-k confidence contrast after immediate-only smoothing
...
# v322: gentle deeper-tail dampening from v259. Keep the top 20 labels after
# top-k contrast and lightly suppress the remaining low-rank tail.
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, gentle tail dampening')
