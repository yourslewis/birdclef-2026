...
def get_ast_model(num_classes):
    # Load AST model pre-trained on AudioSet
    # AST requires specific input shapes (usually 128 mels, 1024 time frames, or resizing via interpolation)
    model = timm.create_model('ast_base_384', pretrained=True, in_chans=1, num_classes=num_classes)
    return model
