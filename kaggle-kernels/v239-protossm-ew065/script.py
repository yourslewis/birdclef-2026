#!/usr/bin/env python3
"""
BirdCLEF 2026 — v239 ProtoSSM EW 0.65 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus stronger within-file context boost (alpha 0.20) and slightly higher ProtoSSM ensemble weight (0.65).
"""
...
print('V239: v238 + ProtoSSM ensemble weight 0.65')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v239 keeps the known-strong v111/v118 family of settings, especially:
