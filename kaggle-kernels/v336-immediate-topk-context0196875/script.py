#!/usr/bin/env python3
"""
BirdCLEF 2026 - v336 Immediate Top-k + Context 0.196875 Kernel
=============================================================================
...
# v336 keeps the known-strong v111/v118 family of settings, especially:
...
# v336: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.196875, gamma 0.85, top-k contrast')
