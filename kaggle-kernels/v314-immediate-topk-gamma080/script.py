#!/usr/bin/env python3
"""
BirdCLEF 2026 - v314 Immediate Top-k Gamma 0.80 Kernel
=============================================================================
...
# v314 keeps the known-strong v111/v118 family of settings, especially:
...
# v314 post-processing: combine immediate-only temporal smoothing and light
# top-k contrast with gamma 0.80. v248 gamma 0.80 tied best on the v245
# smoothing axis, and BirdCLEF 2025 writeups emphasize power adjustment;
# this is the low-gamma sibling of v313 on immediate top-k.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.80, top-k contrast')
