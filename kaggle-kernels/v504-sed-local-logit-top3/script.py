#!/usr/bin/env python3
"""
BirdCLEF 2026 - v504 SED Local Logit Event Top3 + Context 0.25 Kernel
=============================================================================
...
print('V504: SED local logit-event boost top3 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v504 keeps the known-strong v111/v118 family of settings, especially:
...
# v504: SED-inspired local event propagation in logit space. Top BirdCLEF
# 2025 systems used frame-local SED models; v504 boosts only top-3 local
# event logits before sigmoid with a smaller alpha to reduce probability-floor
# inflation for weak secondary species.
...
print(f'  Post: immediate temporal smooth, top3 logit local-event boost, sigmoid, file-context alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
