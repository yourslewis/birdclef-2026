#!/usr/bin/env python3
"""
BirdCLEF 2026 — v287 Probability Smooth + Quantile 0.475 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and a slightly rank-heavier quantile mix.
"""
...
print('V287: probability temporal smoothing + quantile mix alpha 0.475')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v287 keeps the known-strong v111/v118 family of settings, especially:
...
# BirdCLEF writeups describe smoothing predictions/probabilities. v287 also
# leans quantile-mix slightly toward rank-average (alpha=0.475), combining the
# v275 near-mid rank-heavy axis with v285 probability-space smoothing.
