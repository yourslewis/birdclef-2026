#!/usr/bin/env python3
"""
BirdCLEF 2026 — v292 Probability Smooth + Gamma 0.875 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and power gamma 0.875.
"""
...
print('V292: probability temporal smoothing + power gamma 0.875')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v292 keeps the known-strong v111/v118 family of settings, especially:
...
# Smooth in probability space, then apply gamma 0.875. This brackets the
# upper side of the probability-smoothing gamma sweep against v290 gamma 0.90.
...
print(f'  Post: sigmoid → probability temporal smooth → file-context boost → gamma 0.875 power transform')
