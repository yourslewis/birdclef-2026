#!/usr/bin/env python3
"""
BirdCLEF 2026 — v291 Probability Smooth + Gamma 0.825 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus probability-space immediate temporal smoothing and midpoint power gamma 0.825.
"""
...
print('V291: probability temporal smoothing + power gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v291 keeps the known-strong v111/v118 family of settings, especially:
...
# Smooth in probability space, then apply midpoint gamma 0.825. This tests the
# interior between v289 gamma 0.80 and the original v285/v245 gamma 0.85.
...
print(f'  Post: sigmoid → probability temporal smooth → file-context boost → gamma 0.825 power transform')
