#!/usr/bin/env python3
"""
BirdCLEF 2026 - v316 Immediate Top-k Gamma 0.875 Kernel
=============================================================================
...
# v316 keeps the known-strong v111/v118 family of settings, especially:
...
# v316 post-processing: combine immediate-only temporal smoothing and light
# top-k contrast with gamma 0.875. BirdCLEF 2025 writeups emphasize power
# adjustment; v313 tests gamma 0.90 and v305 uses 0.85, so this samples
# the upper midpoint on the immediate top-k axis.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.875, top-k contrast')
