#!/usr/bin/env python3
"""
BirdCLEF 2026 - v382 Immediate Top-k + EW0.575 + Gamma 0.90 + Context 0.25 + Alpha 0.55 Kernel
=============================================================================
...
print('V382: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.90 + context 0.25 + quantile alpha 0.55')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v382 keeps the known-strong v111/v118 family of settings, especially:
...
# v382 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and power gamma0.90 fixed while shifting Quantile-Mix to mean-heavy
# alpha0.55 to test whether simple averaging helps this sharper axis.
TOPK_CONTRAST_K = 5
...
print(f'  Ensemble: mean-heavy quantile-mix ({QUANTILE_MIX_ALPHA} simple + {1-QUANTILE_MIX_ALPHA} rank-avg)')
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 gamma0.90 context0.25 alpha0.55)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.90, top-k contrast, ProtoSSM EW0.575')
