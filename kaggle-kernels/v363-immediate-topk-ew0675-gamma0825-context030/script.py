#!/usr/bin/env python3
"""
BirdCLEF 2026 - v363 Immediate Top-k + EW0.675 + Gamma 0.825 + Context 0.30 Kernel
=============================================================================
...
print('V363: immediate-only top-k + ProtoSSM EW0.675 + power gamma 0.825 + context 0.30')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v363 keeps the known-strong v111/v118 family of settings, especially:
...
POWER_GAMMA = 0.825
FILE_CONTEXT_ALPHA = 0.30
QUANTILE_MIX_ALPHA = 0.5

# v363 post-processing: continue the v268/v362 file-context axis by
# raising file context alpha from 0.25 to 0.30 while keeping the immediate-topk
# ProtoSSM EW0.675 + gamma0.825 family fixed.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (aggressive v268-inspired)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.30, gamma 0.825, top-k contrast, ProtoSSM EW0.675')
