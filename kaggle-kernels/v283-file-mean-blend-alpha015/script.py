#!/usr/bin/env python3
"""
BirdCLEF 2026 — v283 Immediate Temporal + Mid File Mean Blend Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor temporal smoothing and midpoint BirdCLEF-2024-style within-file mean blending.
"""
...
print('V283: immediate-only temporal smoothing + file mean blend context alpha 0.15')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v283 keeps the known-strong v111/v118 family of settings, especially:
...
def file_context_boost(probs, alpha=FILE_CONTEXT_ALPHA):
    ...
    if n_complete_files > 0:
        ...
        # with its per-file mean after temporal smoothing. v283 uses alpha=0.15,
        # the midpoint between v281's original 0.20 and v282's gentler 0.10.
