#!/usr/bin/env python3
"""
BirdCLEF 2026 - v397 Immediate Top-k K2 + EW0.625 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V397: immediate-only top-k K2 + ProtoSSM EW0.625 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v397 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.625 context0.25 topkK2)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, very focused top-k K=2 contrast, ProtoSSM EW0.625')
