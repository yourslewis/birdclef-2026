#!/usr/bin/env python3
"""
BirdCLEF 2026 - v413 Immediate Top-k + EW0.625 + Gamma 0.825 + Context 0.253125 Kernel
=============================================================================
...
print('V413: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.825 + context 0.253125')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v413 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.625 context0.253125)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.253125, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
