#!/usr/bin/env python3
"""
BirdCLEF 2026 — v270 Immediate Temporal + Gamma 0.80 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing and lower power gamma.
"""
...
print('V270: immediate-only temporal smoothing + power gamma 0.80')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v270 keeps the known-strong v111/v118 family of settings, especially:
