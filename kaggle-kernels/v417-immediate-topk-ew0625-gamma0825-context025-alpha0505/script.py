#!/usr/bin/env python3
"""
BirdCLEF 2026 - v417 Immediate Top-k + EW0.625 + Gamma 0.825 + Context 0.25 + Alpha 0.505 Kernel
=============================================================================
...
print('V417: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.825 + context 0.25 + quantile alpha 0.505')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v417 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, quantile alpha 0.505, ProtoSSM EW0.625')
