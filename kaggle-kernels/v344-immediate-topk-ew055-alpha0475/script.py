#!/usr/bin/env python3
"""
BirdCLEF 2026 - v344 Immediate Top-k + EW0.55 + Quantile Alpha 0.475 Kernel
=============================================================================
...
print('V344: immediate-only top-k + ProtoSSM EW0.55 + quantile alpha 0.475')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v344 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v343 lower SED/temporal member weighting)
# - Quantile-Mix alpha = 0.475 (rank-heavier sibling to v343 alpha 0.525)
...
# v344 post-processing: keep the tied-best immediate top-k axis while
# combining ProtoSSM EW=0.55 from v263 with a rank-heavier
# Quantile-Mix alpha=0.475 sibling to v343.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM EW0.55, quantile alpha 0.475')
