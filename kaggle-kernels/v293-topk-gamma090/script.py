#!/usr/bin/env python3
"""
BirdCLEF 2026 - v293 Top-k Contrast + Gamma 0.90 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus combined strong row-wise top-k confidence contrast and gamma 0.90 power scaling.
"""
...
print('V293: v245 smoothing + strong top-k confidence contrast + gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v293 keeps the known-strong v111/v118 family of settings, especially:
...
# v293 post-processing: combine two tied-best axes. v256 showed stronger
# row-wise top-k confidence contrast can hold 0.926 on top of v245, while
# v249 showed gamma 0.90 can also hold 0.926. This tests whether the two
# mild AUC-ranking adjustments are complementary.
TOPK_CONTRAST_K = 5
...
# v293: row-wise top-k contrast after gamma scaling. Boost only the few
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.90, top-k contrast')
