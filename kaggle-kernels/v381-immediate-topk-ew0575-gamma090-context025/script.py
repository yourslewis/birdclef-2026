#!/usr/bin/env python3
"""
BirdCLEF 2026 - v381 Immediate Top-k + EW0.575 + Gamma 0.90 + Context 0.25 Kernel
=============================================================================
...
print('V381: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.90 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v381 keeps the known-strong v111/v118 family of settings, especially:
...
# v381 post-processing: keep the lower-midpoint EW0.575, context0.25,
# and Quantile-Mix alpha0.50 fixed while shifting power gamma to 0.90
# to test whether sharper confidence scaling helps this context axis.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 gamma0.90 context0.25)')
