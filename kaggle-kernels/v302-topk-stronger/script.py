#!/usr/bin/env python3
"""
BirdCLEF 2026 - v302 Stronger Top-k Contrast Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus stronger row-wise top-k confidence contrast on the top 5 labels.
"""
...
print('V302: v245 smoothing + stronger top-k confidence contrast K=5 p0.85/1.15')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v302 keeps the known-strong v111/v118 family of settings, especially:
...
# v302 post-processing: tune the strength of the "top n confident predictions"
# idea from BirdCLEF 2025 notes. v256 used K=5 with p0.90/1.10 and retained
# 0.926; v302 keeps K=5 and original gamma but increases contrast to p0.85/1.15.
TOPK_CONTRAST_K = 5
...
# v302: stronger row-wise top-k contrast after original gamma scaling.
# Boost top 5 labels per row more aggressively and damp the rest more strongly.
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.85, stronger top-k contrast')
