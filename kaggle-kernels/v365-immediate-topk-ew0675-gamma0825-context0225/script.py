#!/usr/bin/env python3
"""
BirdCLEF 2026 - v365 Immediate Top-k + EW0.675 + Gamma 0.825 + Context 0.225 Kernel
=============================================================================
...
print('V365: immediate-only top-k + ProtoSSM EW0.675 + power gamma 0.825 + context 0.225')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v365 keeps the known-strong v111/v118 family of settings, especially:
...
PROTOSSM_ENSEMBLE_WEIGHT = 0.675
...
POWER_GAMMA = 0.825
FILE_CONTEXT_ALPHA = 0.225
QUANTILE_MIX_ALPHA = 0.5

# v365 post-processing: bracket the lower side of the v268/v362/v363/v364
# file-context axis by testing 0.225, below known-good 0.25 but above
# the older 0.20 baseline, while keeping the immediate-topk ProtoSSM EW0.675 + gamma0.825 family fixed.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (lower-bracket v268-inspired)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.225, gamma 0.825, top-k contrast, ProtoSSM EW0.675')
