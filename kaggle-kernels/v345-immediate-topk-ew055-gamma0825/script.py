#!/usr/bin/env python3
"""
BirdCLEF 2026 - v345 Immediate Top-k + EW0.55 + Gamma 0.825 Kernel
=============================================================================
...
print('V345: immediate-only top-k + ProtoSSM EW0.55 + power gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v345 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.55 (v345 lower SED/temporal member weighting)
# - Power gamma = 0.825 (v266 tied-best softer gamma)
...
# v345 post-processing: keep the tied-best immediate top-k axis while
# combining ProtoSSM EW=0.55 from v263 with softer power gamma=0.825
# from v266; both tied best on the v245 axis.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast, ProtoSSM EW0.55')
