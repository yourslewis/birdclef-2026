#!/usr/bin/env python3
"""
BirdCLEF 2026 - v372 Immediate Top-k + EW0.575 + Gamma 0.875 + Context 0.25 Kernel
=============================================================================
...
print('V372: immediate-only top-k + ProtoSSM EW0.575 + power gamma 0.875 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v372 keeps the known-strong v111/v118 family of settings, especially:
...
# v372 post-processing: keep the lower-midpoint EW0.575 and proven
# context0.25 axis, but test sharper power gamma0.875 after the base
# gamma0.875 axis tied best and may interact with stronger context.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.575 context0.25 gamma0.875)')
