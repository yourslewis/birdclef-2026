#!/usr/bin/env python3
"""
BirdCLEF 2026 — v269 Immediate-only Temporal 0.75 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing with center mass 0.75.
"""
...
print('V269: immediate-only temporal smoothing center 0.75')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v269 keeps the known-strong v111/v118 family of settings, especially:
...
# Post-processing
GAUSSIAN_WEIGHTS = np.array([0.00, 0.125, 0.75, 0.125, 0.00], dtype=np.float32)
POWER_GAMMA = 0.85
