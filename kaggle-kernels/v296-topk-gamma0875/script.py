#!/usr/bin/env python3
"""
BirdCLEF 2026 - v296 Top-k Contrast + Gamma 0.875 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus combined strong row-wise top-k confidence contrast and gamma 0.875 power scaling.
"""
...
print('V296: v245 smoothing + strong top-k confidence contrast + gamma 0.875')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v296 keeps the known-strong v111/v118 family of settings, especially:
...
# v296 post-processing: upper midpoint between the original v245/v256 gamma
# 0.85 and v293 gamma 0.90 while keeping the strong v256 top-k contrast.
# This brackets the top-k plus gamma sweep around the original tied-best setup.
TOPK_CONTRAST_K = 5
...
# v296: row-wise top-k contrast after gamma scaling. Boost only the few
...
print(f'  Post: Gaussian smooth, sigmoid, file-context boost, gamma 0.875, top-k contrast')
