...
# v537: compact fold-aware OOF-teacher B0 sidecar.  The source-fold OOF check
# reached 0.943801 on the B0v26+v29 intersection, but the model is B0-derived,
# so use a conservative 2% blend into the current v517 taxon-gated axis.
REAL_SED_BLEND_WEIGHT = 0.02
