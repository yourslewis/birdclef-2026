#!/usr/bin/env python3
"""
BirdCLEF 2026 — v275 Immediate Temporal + Quantile Alpha 0.475 Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor-only temporal smoothing and a very small Quantile-Mix shift toward rank averaging.
"""
...
print('V275: immediate-only temporal smoothing + quantile mix alpha 0.475')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v275 keeps the known-strong v111/v118 family of settings, especially:
