#!/usr/bin/env python3
"""
BirdCLEF 2026 - v505 SED Local Logit Event Top5 + Context 0.25 Kernel
=============================================================================
...
print('V505: SED local logit-event boost top5 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v505 keeps the known-strong v111/v118 family of settings, especially:
...
# v505: SED-inspired local event propagation in logit space. Top BirdCLEF
# 2025 systems used frame-local SED models; v505 broadens the logit-space
# local event set from top-3 to top-5 to better handle multi-species windows
# while keeping the conservative 0.05 alpha from v505.
...
print(f'  Post: immediate temporal smooth, top5 logit local-event boost, sigmoid, file-context alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
