#!/usr/bin/env python3
"""
BirdCLEF 2026 - v364 Immediate Top-k + EW0.675 + Gamma 0.825 + Context 0.275 Kernel
=============================================================================
...
print('V364: immediate-only top-k + ProtoSSM EW0.675 + power gamma 0.825 + context 0.275')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v364 keeps the known-strong v111/v118 family of settings, especially:
...
# v364 post-processing: bracket the v268/v362/v363 file-context axis by
# testing a midpoint file-context alpha 0.275 between known-good 0.25 and
# aggressive 0.30 while keeping the immediate-topk ProtoSSM EW0.675 + gamma0.825 family fixed.
TOPK_CONTRAST_K = 5
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (midpoint v268-inspired)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.275, gamma 0.825, top-k contrast, ProtoSSM EW0.675')
