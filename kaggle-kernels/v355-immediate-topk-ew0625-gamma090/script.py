#!/usr/bin/env python3
"""
BirdCLEF 2026 - v355 Immediate Top-k + EW0.625 + Gamma 0.90 Kernel
=============================================================================
...
print('V355: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.90')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v355 keeps the known-strong v111/v118 family of settings, especially:
...
# v355 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.625 and pairing it with gamma=0.90;
# this completes the upper endpoint of the EW0.625 gamma bracket.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.90, top-k contrast, ProtoSSM EW0.625')
