#!/usr/bin/env python3
"""
BirdCLEF 2026 - v338 Immediate Top-k + ProtoSSM Weight 0.625 Kernel
=============================================================================
...
print('V338: immediate-only temporal smoothing + top-k contrast + ProtoSSM ensemble weight 0.625')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v338 keeps the known-strong v111/v118 family of settings, especially:
# - ProtoSSM ensemble weight = 0.625 (v338 tiny stronger SED/temporal member weighting)
...
# v338 post-processing: keep the tied-best immediate top-k axis while
# testing a slightly stronger ProtoSSM temporal member. BirdCLEF 2025
# solutions emphasize SED/model-diverse ensembles; this nudges the
# learned temporal SED-style component from 0.60 to 0.625.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.85, top-k contrast, ProtoSSM weight 0.625')
