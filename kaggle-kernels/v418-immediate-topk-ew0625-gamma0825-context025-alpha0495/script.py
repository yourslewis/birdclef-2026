#!/usr/bin/env python3
"""
BirdCLEF 2026 - v418 Immediate Top-k + EW0.625 + Gamma 0.825 + Context 0.25 + Alpha 0.495 Kernel
=============================================================================
...
print('V418: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.825 + context 0.25 + quantile alpha 0.495')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v418 keeps the known-strong v111/v118 family of settings, especially:
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, quantile alpha 0.495, ProtoSSM EW0.625')
