#!/usr/bin/env python3
"""
BirdCLEF 2026 - v353 Immediate Top-k + EW0.625 + Gamma 0.825 Kernel
=============================================================================
...
print('V353: immediate-only top-k + ProtoSSM EW0.625 + power gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v353 keeps the known-strong v111/v118 family of settings, especially:
...
# v353 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.625 and pairing it with gamma=0.825;
# this tests the next model-diversity step after completing EW0.60 gamma bracket.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast, ProtoSSM EW0.625')
