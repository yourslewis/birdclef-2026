#!/usr/bin/env python3
"""
BirdCLEF 2026 - v406 Immediate Top-k + EW0.5875 + Gamma 0.825 + Context 0.25 Kernel
=============================================================================
...
print('V406: immediate-only top-k + ProtoSSM EW0.5875 + power gamma 0.825 + context 0.25')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v406 keeps the known-strong v111/v118 family of settings, especially:
...
PROTOSSM_ENSEMBLE_WEIGHT = 0.5875
...
print(f'  Power gamma={POWER_GAMMA}, File context alpha={FILE_CONTEXT_ALPHA} (EW0.5875 context0.25)')
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.25, gamma 0.825, top-k contrast, ProtoSSM EW0.5875')
