#!/usr/bin/env python3
"""
BirdCLEF 2026 — v250 Immediate-Only Temporal Smoothing Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor temporal smoothing: keep v245 center mass but remove ±2-window leakage.
"""
...
print('V250: immediate-only temporal smoothing center 0.70')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v250 keeps the known-strong v111/v118 family of settings, especially:
