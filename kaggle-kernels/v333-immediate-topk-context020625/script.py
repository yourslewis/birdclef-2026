#!/usr/bin/env python3
"""
BirdCLEF 2026 - v333 Immediate Top-k + Context 0.20625 Kernel
=============================================================================
...
# v333 keeps the known-strong v111/v118 family of settings, especially:
...
# v333: row-wise top-k contrast after immediate-only smoothing and original
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost alpha 0.20625, gamma 0.85, top-k contrast')
