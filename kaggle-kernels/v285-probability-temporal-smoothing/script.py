#!/usr/bin/env python3
"""
BirdCLEF 2026 — v285 Probability Temporal Smoothing Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus immediate-neighbor temporal smoothing applied in probability space.
"""
...
print('V285: immediate-only temporal smoothing applied after sigmoid/probabilities')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v285 keeps the known-strong v111/v118 family of settings, especially:
...
# BirdCLEF solution writeups describe smoothing predictions/probabilities.
# Prior kernels smoothed logits before sigmoid; v285 tests smoothing after sigmoid
# so temporal sharing operates directly in AUC probability/ranking space.
