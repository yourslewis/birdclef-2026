#!/usr/bin/env python3
"""
BirdCLEF 2026 - v361 Immediate Top-k + EW0.675 + Gamma 0.825 Kernel
=============================================================================
...
print('V361: immediate-only top-k + ProtoSSM EW0.675 + power gamma 0.825')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v361 keeps the known-strong v111/v118 family of settings, especially:
...
# v361 post-processing: keep the tied-best immediate top-k axis while
# nudging ProtoSSM upward to EW=0.675 and pairing it with gamma=0.825;
# this probes whether more model-diversity weight helps after EW0.65 bracket.
TOPK_CONTRAST_K = 5
...
print(f'  Post: immediate temporal smooth, sigmoid, file-context boost, gamma 0.825, top-k contrast, ProtoSSM EW0.675')
