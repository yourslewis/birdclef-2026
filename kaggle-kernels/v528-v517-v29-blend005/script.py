...
print(f'  Taxon max gate: floor={TAXON_MAX_GATE_FLOOR}, alpha={TAXON_MAX_GATE_ALPHA}')
print(f'  Post: v508 immediate temporal/logit local-event axis + conservative v29 20s/128 broad NFNet blend weight {REAL_SED_BLEND_WEIGHT}, then v517 taxon max gate')
