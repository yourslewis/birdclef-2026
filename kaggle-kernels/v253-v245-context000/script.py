#!/usr/bin/env python3
"""
BirdCLEF 2026 — v253 v245 Smoothing + No File Context Kernel
=============================================================================
...
- Target behavior: improve over the current 0.923 LB anchor by combining v111/v118
  strengths plus v245 center-preserving temporal smoothing with no within-file context boost.
"""
...
print('V253: v245 smoothing + no file context boost')

# === Cell: Settings ===
# All high-impact knobs are centralized here so experiments can be audited.
# v253 keeps the known-strong v111/v118 family of settings, especially:
