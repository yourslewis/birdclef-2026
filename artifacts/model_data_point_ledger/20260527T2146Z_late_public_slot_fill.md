...
|---|---|---|---:|---:|---:|---|---|
| v626 | Perch meta/probe soundscape source | `shahadaljayzani/bc2026-claude-jaejohn-perch-starter-fork` | 53097345 | 240 | 95 | `7439ae3b15a3f6c6` | complete `0.899` |
...
| v628 | Gate-combo ensemble | `sultanalgizani/bc2026-claude-cliff-gate-combo-fork` | 53097347 | 3 | 95 | `aa41ccbbf2a84046` | complete `0.940` |
| v629 | BirdNET/Yaroslav public source | `hassanalgizani/bc2026-claude-yaroslav-birdnet-3rd-fork` | 53097348 | 3 | 92 | `3224ced9a582e251` | complete `0.946` |
...
- Score update by 2026-05-28 00:16 UTC: all five completed below the repo-owned v616/v621-v623 tied baseline: v626 `0.899`, v627 `0.928`, v628 `0.940`, v629 `0.946`, v630 `0.917`.
- Decision after completion: reject all five as below-best public source reruns. Resume repo-owned hidden-safe 234-class PANNs/fused sequence packaging or no-call/acoustic-context protocol.
