# soundscape-nocall-gate-soft1279native-trio-losite-20260528 — no-call/background gate data point — 2026-05-28 20:23 UTC
...
## Model / validation
- Model: balanced logistic over 3×234 class probs + confidence summaries from soft1279-native packages.
- Split: leave-one-site OOF; only sites with both positive and weak-negative windows have valid per-site AUC.
- Artifact metrics: `artifacts/soundscape_nocall_gate/soundscape-nocall-gate-soft1279native-trio-losite-20260528/metrics.json`.
- Prediction artifact: `artifacts/soundscape_nocall_gate/soundscape-nocall-gate-soft1279native-trio-losite-20260528/nocall_gate_predictions.csv`.

## Metrics
- Primary: leave-site OOF any-call/no-call ROC-AUC `0.530166` over 792 rows / 3 valid sites.
- Site AUC mean/min/q05: `0.553919` / `0.185185` / `0.230466`.
- Mean OOF predicted any-call: positives `0.813461`, weak-background `0.964517`.
- Best simple raw confidence baseline: `soft1279enc_native_max_auc` = `0.977098`; delta `-0.446932`.

## Decision
- reject; high-dimensional class-prob gate overfit/no-call OOF inverted on S18.
