"""Poll v267 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v267-v245-temporal075"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v267: v245 family + intermediate temporal smoothing center 0.75"
