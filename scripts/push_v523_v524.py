"""Push v523/v524 taxon-gate follow-up kernels with KGAT Bearer auth."""
import json
import os
from pathlib import Path
import requests
FOLDERS = [
    Path('kaggle-kernels/v523-taxon-max-gate-alpha0875'),
    Path('kaggle-kernels/v524-taxon-max-gate-floor020'),
]
