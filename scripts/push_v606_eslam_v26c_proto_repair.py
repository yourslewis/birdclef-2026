"""Push v606 Eslam v26C ProtoSSM repair verification kernel via Bearer API v1."""
import json, os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v606-eslam-v26c-proto-repair'))
...
print('Pushing v606 Eslam v26C ProtoSSM repair kernel...')
resp = requests.post(
