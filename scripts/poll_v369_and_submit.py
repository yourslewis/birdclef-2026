"""Poll v369 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v369-ew065-g0825-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v369: immediate top-k + ProtoSSM EW0.65 + gamma 0.825 + context alpha 0.25"
