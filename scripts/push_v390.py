"""Push v390 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v390-immediate-topk-ew0625-gamma0825-context025-alpha055'))
...
print('Pushing kernel v390-immediate-topk-ew0625-gamma0825-context025-alpha055...')
resp = requests.post(
