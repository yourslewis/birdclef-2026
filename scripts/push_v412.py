"""Push v412 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v412-immediate-topk-ew0625-gamma0825-context025625'))
...
print('Pushing kernel v412-immediate-topk-ew0625-gamma0825-context025625...')
resp = requests.post(
