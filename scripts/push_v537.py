"""Push v537 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v537-v517-oofteacher-sourcefold-blend002'))
...
print('Pushing kernel v537-v517-oofteacher-sourcefold-blend002...')
resp = requests.post(
