"""Poll v254 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v254-v245-context005"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v254: v245 smoothing + very light file context alpha 0.05"
