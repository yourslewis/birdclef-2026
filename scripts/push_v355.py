"""Push v355 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v355-immediate-topk-ew0625-gamma090'))
...
print('Pushing kernel v355-immediate-topk-ew0625-gamma090...')
resp = requests.post(
