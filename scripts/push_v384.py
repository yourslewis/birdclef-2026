"""Push v384 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v384-immediate-topk-ew0625-gamma080-context025'))
...
print('Pushing kernel v384-immediate-topk-ew0625-gamma080-context025...')
resp = requests.post(
