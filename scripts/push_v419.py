"""Push v419 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v419-immediate-topk-ew0625-gamma0825-context025-alpha05025'))
...
print('Pushing kernel v419-immediate-topk-ew0625-gamma0825-context025-alpha05025...')
resp = requests.post(
