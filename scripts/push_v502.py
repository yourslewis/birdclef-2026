"""Push v502 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v502-sed-local-event-top5'))
...
print('Pushing kernel v502-sed-local-event-top5...')
resp = requests.post(
