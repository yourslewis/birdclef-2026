"""Poll v271 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v271-immediate-gamma090"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v271: immediate-only temporal smoothing + power gamma 0.90"
