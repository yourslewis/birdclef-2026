"""Poll v503 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v503-sed-local-top3"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v503: SED local event boost top3 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"
