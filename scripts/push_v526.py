"""Push v526 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v526-v516-v23d-blend005'))
...
print('Pushing kernel v526-v516-v23d-blend005...')
