"""Poll v509 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v509-nocall-confidence-gate"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v509: Spec E no-call confidence gate + SED local logit top3 + EW0.625 + gamma 0.825 + context alpha 0.275"
