"""Poll v270 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v270-immediate-gamma080"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v270: immediate-only temporal smoothing + power gamma 0.80"
