"""Poll v243 and submit completed kernel version to BirdCLEF 2026."""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v243-quantile-alpha-04"
...
while True:
    ...
    if "COMPLETE" in status_text or "complete" in status_text.lower():
        ...
        res = api.competition_submit_code(
            ...
            message="v243: v238 + quantile mix alpha 0.40",
