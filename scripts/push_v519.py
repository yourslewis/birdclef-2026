"""Push v519 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v519-student-b0-5s-ep12init-blend015'))
...
print('Pushing kernel v519-student-b0-5s-ep12init-blend015...')
