"""Push v531 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v531-v517-v29-fast1-blend002'))
...
print('Pushing kernel v531-v517-v29-fast1-blend002...')
