"""Poll v373 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v373-ew0575-g0825-ctx025-a0475"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v373: immediate top-k + ProtoSSM EW0.575 + gamma 0.825 + context 0.25 + quantile alpha 0.475"
