"""Push v378 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v378-immediate-topk-ew0575-gamma0875-context025-alpha045'))
...
print('Pushing kernel v378-immediate-topk-ew0575-gamma0875-context025-alpha045...')
resp = requests.post(
