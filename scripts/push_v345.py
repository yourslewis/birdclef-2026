"""Push v345 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v345-immediate-topk-ew055-gamma0825'))
...
print('Pushing kernel v345-immediate-topk-ew055-gamma0825...')
resp = requests.post(
