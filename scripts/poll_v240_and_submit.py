"""Poll v240 and submit completed kernel version to BirdCLEF 2026."""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v240-topk-contrast"
...
while True:
    ...
    if "COMPLETE" in status_text or "complete" in status_text.lower():
        ...
        res = api.competition_submit_code(
            ...
            message="v240: v239 + light row-wise top-k contrast postprocess",
