"""Push v543 Public946 BirdNET 3-way Kaggle kernel with Bearer auth."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v543-public946-birdnet3'))
...
print('Pushing kernel v543-public946-birdnet3...')
resp = requests.post(
