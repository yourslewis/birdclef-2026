"""Push v385 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v385-immediate-topk-ew060-gamma080-context025'))
...
print('Pushing kernel v385-immediate-topk-ew060-gamma080-context025...')
resp = requests.post(
