"""Push v404 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v404-immediate-topk-ew06125-gamma0825-context025'))
...
print('Pushing kernel v404-immediate-topk-ew06125-gamma0825-context025...')
resp = requests.post(
