"""Push v398 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v398-immediate-topk-ew0625-gamma0825-context025-strong-contrast'))
...
print('Pushing kernel v398-immediate-topk-ew0625-gamma0825-context025-strong-contrast...')
resp = requests.post(
