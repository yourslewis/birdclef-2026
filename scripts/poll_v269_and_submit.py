"""Poll v269 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v269-immediate-temporal075"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v269: immediate-only temporal smoothing center 0.75"
