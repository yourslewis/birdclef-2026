"""Poll v262 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v262-v245-quantile-alpha0525"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v262: v245 smoothing + quantile mix alpha 0.525"
