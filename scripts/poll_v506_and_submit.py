"""Poll v506 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v506-sed-logit-top5-a0025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v506: SED local logit-event boost top5 alpha0.025 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"
