"""Push v405 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v405-immediate-topk-ew06375-gamma0825-context025'))
...
print('Pushing kernel v405-immediate-topk-ew06375-gamma0825-context025...')
resp = requests.post(
