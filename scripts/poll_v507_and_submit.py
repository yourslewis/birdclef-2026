"""Poll v507 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v507-sed-logit-top3-ew060"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v507: SED local logit-event boost top3 + ProtoSSM EW0.60 + gamma 0.825 + context alpha 0.25"
