"""Push v500 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v500-sed-local-event-boost'))
...
print('Pushing kernel v500-sed-local-event-boost...')
resp = requests.post(
