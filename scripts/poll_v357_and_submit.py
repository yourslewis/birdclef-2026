"""Poll v357 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v357-immediate-topk-ew065-gamma0825"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v357: immediate top-k + ProtoSSM EW0.65 + power gamma 0.825"
