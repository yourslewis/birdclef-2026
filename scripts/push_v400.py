"""Push v400 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v400-immediate-topk-ew0625-gamma0825-context025-damp-only'))
...
print('Pushing kernel v400-immediate-topk-ew0625-gamma0825-context025-damp-only...')
resp = requests.post(
