"""Push v413 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v413-immediate-topk-ew0625-gamma0825-context0253125'))
...
print('Pushing kernel v413-immediate-topk-ew0625-gamma0825-context0253125...')
resp = requests.post(
