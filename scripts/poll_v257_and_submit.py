"""Poll v257 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v257-v245-tail-damp"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v257: v245 smoothing + low-rank tail dampening"
