"""Push repo-owned v577 EoS5 Model5 rank-aware power 0.55 ablation."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v577-eos5-model5-rankp055'))
...
print('Pushing v577 repo-owned EoS5 Model5 rank-power 0.55 notebook...')
resp = requests.post(
