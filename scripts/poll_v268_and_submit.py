"""Poll v268 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v268-v245-context025"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v268: v245 smoothing + stronger file context alpha 0.25"
