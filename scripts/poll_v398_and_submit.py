"""Poll v398 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v398-ew0625-g0825-ctx025-p085115"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v398: immediate top-k strong contrast p0.85/1.15 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
