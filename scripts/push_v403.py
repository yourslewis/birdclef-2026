"""Push v403 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v403-immediate-topk-ew0625-gamma0825-context030'))
...
print('Pushing kernel v403-immediate-topk-ew0625-gamma0825-context030...')
resp = requests.post(
