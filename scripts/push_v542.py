"""Push v542 Afr1ste updated public946 Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v542-afr1ste-updated-public946'))
...
print('Pushing kernel v542-afr1ste-updated-public946...')
resp = requests.post(
