"""Poll v378 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v378-ew0575-g0875-ctx025-a045"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v378: immediate top-k + ProtoSSM EW0.575 + gamma 0.875 + context 0.25 + quantile alpha 0.45"
