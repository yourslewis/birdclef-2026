"""Poll v367 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v367-ew060-g0825-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v367: immediate top-k + ProtoSSM EW0.60 + gamma 0.825 + context alpha 0.25"
