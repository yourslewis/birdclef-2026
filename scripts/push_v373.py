"""Push v373 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v373-immediate-topk-ew0575-gamma0825-context025-alpha0475'))
...
print('Pushing kernel v373-immediate-topk-ew0575-gamma0825-context025-alpha0475...')
resp = requests.post(
