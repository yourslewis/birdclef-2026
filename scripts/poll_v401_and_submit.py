"""Poll v401 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v401-ew0625-g0825-ctx025-p095105"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v401: immediate top-k mild contrast p0.95/1.05 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
