"""Push v605 Eslam v26C source verification kernel via Bearer API v1."""
import json, os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v605-eslam-v26c-verify'))
...
print('Pushing v605 Eslam v26C verification kernel...')
resp = requests.post(
