"""Poll v384 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v384-ew0625-g080-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v384: immediate top-k + ProtoSSM EW0.625 + gamma 0.80 + context 0.25"
