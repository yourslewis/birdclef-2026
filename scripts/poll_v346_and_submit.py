"""Poll v346 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v346-immediate-topk-ew055-gamma0875"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v346: immediate top-k + ProtoSSM EW0.55 + power gamma 0.875"
