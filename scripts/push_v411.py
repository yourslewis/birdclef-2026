"""Push v411 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v411-immediate-topk-ew0625-gamma0825-context02625'))
...
print('Pushing kernel v411-immediate-topk-ew0625-gamma0825-context02625...')
resp = requests.post(
