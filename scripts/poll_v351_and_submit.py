"""Poll v351 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v351-immediate-topk-ew060-gamma090"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v351: immediate top-k + ProtoSSM EW0.60 + power gamma 0.90"
