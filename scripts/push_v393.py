"""Push v393 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v393-immediate-topk-ew0625-gamma0825-context025-k4'))
...
print('Pushing kernel v393-immediate-topk-ew0625-gamma0825-context025-k4...')
resp = requests.post(
