"""Push v520 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v520-sed-b0-ep12init-v23-blend005'))
...
print('Pushing kernel v520-sed-b0-ep12init-v23-blend005...')
