"""Push v386 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v386-immediate-topk-ew0625-gamma0875-context025'))
...
print('Pushing kernel v386-immediate-topk-ew0625-gamma0875-context025...')
resp = requests.post(
