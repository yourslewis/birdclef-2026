"""Poll v255 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v255-v245-topk-contrast"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v255: v245 smoothing + light top-k confidence contrast"
