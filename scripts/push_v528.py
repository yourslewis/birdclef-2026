"""Push v528 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v528-v517-v29-blend005'))
...
print('Pushing kernel v528-v517-v29-blend005...')
