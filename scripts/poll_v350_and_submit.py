"""Poll v350 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v350-immediate-topk-ew060-gamma0875"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v350: immediate top-k + ProtoSSM EW0.60 + power gamma 0.875"
