"""Push v395 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v395-immediate-topk-ew0625-gamma0825-context025-k7'))
...
print('Pushing kernel v395-immediate-topk-ew0625-gamma0825-context025-k7...')
resp = requests.post(
