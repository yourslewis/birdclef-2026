"""Push v410 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v410-immediate-topk-ew0625-gamma0825-context02375'))
...
print('Pushing kernel v410-immediate-topk-ew0625-gamma0825-context02375...')
resp = requests.post(
