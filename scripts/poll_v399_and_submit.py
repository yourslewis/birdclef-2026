"""Poll v399 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v399-ew0625-g0825-ctx025-p085100"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v399: immediate top-k boost-only p0.85/1.00 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
