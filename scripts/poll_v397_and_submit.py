"""Poll v397 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v397-ew0625-g0825-ctx025-k2"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v397: immediate top-k K=2 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
