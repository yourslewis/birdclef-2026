"""Poll v252 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v252-v245-context010"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v252: v245 smoothing + lighter file context alpha 0.10"
