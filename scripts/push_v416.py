"""Push v416 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v416-immediate-topk-ew0625-gamma0825-context024921875'))
...
print('Pushing kernel v416-immediate-topk-ew0625-gamma0825-context024921875...')
resp = requests.post(
