"""Push v351 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v351-immediate-topk-ew060-gamma090'))
...
print('Pushing kernel v351-immediate-topk-ew060-gamma090...')
resp = requests.post(
