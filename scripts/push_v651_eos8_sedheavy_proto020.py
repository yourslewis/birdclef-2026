#!/usr/bin/env python3
"""Push v651 EoS8 SED-heavy Proto020 private verifier kernel via Kaggle Bearer API."""
import json, os
from pathlib import Path
import requests
FOLDER = Path(__file__).resolve().parents[1] / 'kaggle-kernels' / 'v651-eos8-sedheavy-proto020'
...
print(json.dumps({'pushing': META['id'], 'title': META.get('title'), 'source_chars': len(TEXT)}, indent=2), flush=True)
