"""Poll v500 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v500-sed-local-event-boost"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v500: SED-inspired local event boost + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.20"
