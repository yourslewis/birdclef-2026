"""Poll v365 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v365-ew0675-g0825-ctx0225"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v365: immediate top-k + ProtoSSM EW0.675 + gamma 0.825 + context alpha 0.225"
