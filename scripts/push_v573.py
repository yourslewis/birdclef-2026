"""Push v573 public946 + cw0.75 20s B0 rank 1.5% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v573-public946-cw075-20s-b0-w0015'))
...
print('Pushing kernel v573-public946-cw075-20s-b0-w0015...')
resp = requests.post(
