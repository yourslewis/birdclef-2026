"""Poll v239 and submit completed kernel version to BirdCLEF 2026."""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v239-protossm-ew-0-65"
...
while True:
    ...
    if "COMPLETE" in status_text or "complete" in status_text.lower():
        ...
        res = api.competition_submit_code(
            ...
            message="v239: v238 + ProtoSSM ensemble weight 0.65",
