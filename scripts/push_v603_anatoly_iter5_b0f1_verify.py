"""Push v603 Anatoly Iter5 B0F1 private verification kernel via Kaggle Bearer API."""
import json, os
from pathlib import Path
import requests
FOLDER=Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v603-anatoly-iter5-b0f1-verify'))
