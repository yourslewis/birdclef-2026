"""Poll v263 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v263-v245-protossm-ew055"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v263: v245 smoothing + ProtoSSM ensemble weight 0.55"
