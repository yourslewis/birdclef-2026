"""Poll v272 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v272-immediate-quantile055"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v272: immediate-only temporal smoothing + quantile mix alpha 0.55"
