"""Push v612 anchored Samejima HGNet-v57 PT sidecar private validation kernel via Kaggle Bearer API."""
import json
import os
...
FOLDER = Path(__file__).resolve().parents[1] / "kaggle-kernels" / "v612-anchored-sameji-hgnet57-pt"
