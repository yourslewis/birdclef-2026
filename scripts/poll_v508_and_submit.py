"""Poll v508 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v508-sed-logit-top3-ctx0275"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v508: SED local logit-event boost top3 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.275"
