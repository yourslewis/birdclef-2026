"""Poll v372 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v372-ew0575-g0875-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v372: immediate top-k + ProtoSSM EW0.575 + gamma 0.875 + context alpha 0.25"
