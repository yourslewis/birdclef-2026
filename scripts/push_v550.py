"""Push v550 public946 + Snowflake SED 1% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v550-public946-snowflake-sed-w001'))
...
print('Pushing kernel v550-public946-snowflake-sed-w001...')
resp = requests.post(
