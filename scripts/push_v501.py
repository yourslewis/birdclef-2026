"""Push v501 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v501-sed-local-event-conservative-ctx025'))
...
print('Pushing kernel v501-sed-local-event-conservative-ctx025...')
resp = requests.post(
