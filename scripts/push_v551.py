"""Push v551 public946 + CLAP INT8 0.5% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v551-public946-clap-int8-w0005'))
...
print('Pushing kernel v551-public946-clap-int8-w0005...')
resp = requests.post(
