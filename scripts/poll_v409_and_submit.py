"""Poll v409 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v409-ew0625-g0825-ctx0275"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v409: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.275"
