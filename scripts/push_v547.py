"""Push v547 public946 + CV9245 Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v547-public946-cv9245'))
...
print('Pushing kernel v547-public946-cv9245...')
resp = requests.post(
