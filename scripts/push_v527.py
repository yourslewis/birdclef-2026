"""Push v527 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v527-taxon-max-gate-alpha0375'))
...
print('Pushing kernel v527-taxon-max-gate-alpha0375...')
