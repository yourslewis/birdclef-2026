"""Push v591 public946 + Qiuzi HGNet distill sidecar Kaggle kernel via Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v591-public946-hgnet-distill-w0025'))
...
print('Pushing v591 public946 HGNet distill kernel...')
resp = requests.post(
