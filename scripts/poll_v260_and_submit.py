"""Poll v260 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v260-v245-quantile-alpha055"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v260: v245 smoothing + quantile mix alpha 0.55"
