"""Poll v395 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v395-ew0625-g0825-ctx025-k7"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v395: immediate top-k K=7 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
