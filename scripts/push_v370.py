"""Push v370 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v370-immediate-topk-ew0575-gamma0825-context025'))
...
print('Pushing kernel v370-immediate-topk-ew0575-gamma0825-context025...')
resp = requests.post(
