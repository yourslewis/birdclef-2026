"""Poll v291 and submit completed kernel version to BirdCLEF 2026."""
import json, os, re, time
from kaggle.api.kaggle_api_extended import KaggleApi
with open(os.path.expanduser("~/.kaggle/kaggle.json")) as f:
    os.environ["KAGGLE_API_TOKEN"] = json.load(f)["key"]
api=KaggleApi(); api.authenticate()
slug="yourslewis/bc26-v291-prob-smooth-gamma0825"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v291: probability temporal smoothing + power gamma 0.825"
