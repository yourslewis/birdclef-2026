"""Poll v505 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v505-sed-logit-top5"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v505: SED local logit-event boost top5 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"
