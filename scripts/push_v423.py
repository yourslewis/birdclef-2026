"""Push v423 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v423-immediate-topk-ew0625-gamma0825-context025-alpha0499375'))
...
print('Pushing kernel v423-immediate-topk-ew0625-gamma0825-context025-alpha0499375...')
resp = requests.post(
