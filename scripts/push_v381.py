"""Push v381 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v381-immediate-topk-ew0575-gamma090-context025'))
...
print('Pushing kernel v381-immediate-topk-ew0575-gamma090-context025...')
resp = requests.post(
