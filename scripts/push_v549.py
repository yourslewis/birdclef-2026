"""Push v549 public946 + CV9245 1% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v549-public946-cv9245-w001'))
...
print('Pushing kernel v549-public946-cv9245-w001...')
resp = requests.post(
