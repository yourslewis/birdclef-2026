"""Push v417 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v417-immediate-topk-ew0625-gamma0825-context025-alpha0505'))
...
print('Pushing kernel v417-immediate-topk-ew0625-gamma0825-context025-alpha0505...')
resp = requests.post(
