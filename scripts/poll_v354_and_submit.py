"""Poll v354 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v354-immediate-topk-ew0625-gamma0875"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v354: immediate top-k + ProtoSSM EW0.625 + power gamma 0.875"
