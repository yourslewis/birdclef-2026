"""Push v388 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v388-immediate-topk-ew0625-gamma0825-context025-alpha0525'))
...
print('Pushing kernel v388-immediate-topk-ew0625-gamma0825-context025-alpha0525...')
resp = requests.post(
