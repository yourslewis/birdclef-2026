"""Poll v387 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v387-ew060-g0875-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v387: immediate top-k + ProtoSSM EW0.60 + gamma 0.875 + context 0.25"
