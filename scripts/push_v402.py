"""Push v402 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v402-immediate-ew0625-gamma0825-context025-no-topk'))
...
print('Pushing kernel v402-immediate-ew0625-gamma0825-context025-no-topk...')
resp = requests.post(
