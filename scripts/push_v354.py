"""Push v354 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v354-immediate-topk-ew0625-gamma0875'))
...
print('Pushing kernel v354-immediate-topk-ew0625-gamma0875...')
resp = requests.post(
