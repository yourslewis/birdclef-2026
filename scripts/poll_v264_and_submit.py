"""Poll v264 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v264-v245-protossm-ew050"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v264: v245 smoothing + ProtoSSM ensemble weight 0.50"
