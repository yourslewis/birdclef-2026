"""Poll v366 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v366-ew055-g0825-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v366: immediate top-k + ProtoSSM EW0.55 + gamma 0.825 + context alpha 0.25"
