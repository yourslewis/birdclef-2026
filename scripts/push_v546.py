"""Push v546 public946 + train-audio-head Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v546-public946-train-audio-head'))
...
print('Pushing kernel v546-public946-train-audio-head...')
resp = requests.post(
