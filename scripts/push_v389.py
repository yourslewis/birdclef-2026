"""Push v389 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v389-immediate-topk-ew0625-gamma0825-context025-alpha0475'))
...
print('Pushing kernel v389-immediate-topk-ew0625-gamma0825-context025-alpha0475...')
resp = requests.post(
