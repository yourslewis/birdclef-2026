"""Poll v256 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v256-v245-strong-topk-contrast"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v256: v245 smoothing + stronger top-k confidence contrast"
