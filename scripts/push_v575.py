"""Push repo-owned v575 EoS5 confirmation Kaggle notebook with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v575-eos5-repo-confirm'))
...
print('Pushing v575 repo-owned EoS5 confirmation notebook...')
resp = requests.post(
