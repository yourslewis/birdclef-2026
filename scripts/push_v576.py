"""Push repo-owned v576 EoS5 Model5-only ablation Kaggle notebook with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v576-eos5-model5-only'))
...
print('Pushing v576 repo-owned EoS5 Model5-only ablation notebook...')
resp = requests.post(
