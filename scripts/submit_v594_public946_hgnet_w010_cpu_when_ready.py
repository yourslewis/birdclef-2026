"""Guarded submitter for v594 public946 + Qiuzi HGNet 10% sidecar CPU metadata fix.
...
complete Qiuzi 4-fold HGNetV2-B0 distill artifact as a 10% rank sidecar.
"""
...
KERNEL_SLUG = "bc26-v592-public946-hgnet-distill-w010"
KERNEL_VERSION = 2
DESCRIPTION = "v594: Repo-owned public946 plus Qiuzi HGNet rank sidecar 10pct CPU v2"

# Markers chosen to distinguish this from generic EoS/Karnak/S114 clones.
REQUIRED_SOURCE_MARKERS = [
    "HGNET_RANK_WEIGHT = 0.10",
    "submission_hgnet.csv",
    "Executing v592 3-way rank blend",
    "HGNet audio file not found",
    "test_soundscapes",
    "train_soundscapes",
...
def output_preflight(kernels) -> bool:
    ...
    with open("logs/v594_public946_hgnet_w010_cpu_preflight.txt", "w") as f:
...
def main():
    ...
    if any(str(s.description) == DESCRIPTION for s in submissions):
        print("v594 already submitted; exiting", flush=True)
        return
