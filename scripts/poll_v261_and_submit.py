"""Poll v261 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v261-v245-quantile-alpha045"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v261: v245 smoothing + quantile mix alpha 0.45"
