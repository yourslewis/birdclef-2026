"""Push v553 public946 + ConvNeXt-tiny student + taxon gate Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v553-public946-convnext-student-r075-taxon-a050'))
...
print('Pushing kernel v553-public946-convnext-student-r075-taxon-a050...')
resp = requests.post(
