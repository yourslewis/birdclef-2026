"""Push v406 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v406-immediate-topk-ew05875-gamma0825-context025'))
...
print('Pushing kernel v406-immediate-topk-ew05875-gamma0825-context025...')
resp = requests.post(
