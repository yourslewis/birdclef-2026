"""Poll v241 and submit completed kernel version to BirdCLEF 2026."""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v241-strong-topk-contrast"
...
while True:
    ...
    if "COMPLETE" in status_text or "complete" in status_text.lower():
        ...
        res = api.competition_submit_code(
            ...
            message="v241: v240 + stronger top-k contrast k5 p0.90/1.10",
