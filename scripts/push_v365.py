"""Push v365 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v365-immediate-topk-ew0675-gamma0825-context0225'))
...
print('Pushing kernel v365-immediate-topk-ew0675-gamma0825-context0225...')
resp = requests.post(
