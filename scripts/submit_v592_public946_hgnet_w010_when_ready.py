"""Guarded submitter for v592 public946 + Qiuzi HGNet 10% sidecar.
...
KERNEL_VERSION = 1
DESCRIPTION = "v592: Repo-owned public946 plus Qiuzi HGNet rank sidecar 10pct"
...
def output_preflight(kernels) -> bool:
    ...
    with open("logs/v592_public946_hgnet_w010_preflight.txt", "w") as f:
...
def main():
    ...
    if any(str(s.description) == DESCRIPTION for s in submissions):
        print("v592 already submitted; exiting", flush=True)
        return
