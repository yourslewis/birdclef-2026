"""Push v552 public946 + ConvNeXt-tiny student rank 7.5% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v552-public946-convnext-student-rank075'))
...
print('Pushing kernel v552-public946-convnext-student-rank075...')
resp = requests.post(
