"""Push v555 conservative public946 gate-retune Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v555-public946-gateretune-a033'))
...
print('Pushing kernel v555-public946-gateretune-a033...')
resp = requests.post(
