"""Push v346 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v346-immediate-topk-ew055-gamma0875'))
...
print('Pushing kernel v346-immediate-topk-ew055-gamma0875...')
resp = requests.post(
