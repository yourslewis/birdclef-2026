"""Push v505 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v505-sed-local-logit-top5'))
...
print('Pushing kernel v505-sed-local-logit-top5...')
resp = requests.post(
