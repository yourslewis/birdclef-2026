"""Push v538 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v538-v517-oofteacher-sourcefold-blend005'))
...
print('Pushing kernel v538-v517-oofteacher-sourcefold-blend005...')
resp = requests.post(
