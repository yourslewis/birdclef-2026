"""Push v357 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v357-immediate-topk-ew065-gamma0825'))
...
print('Pushing kernel v357-immediate-topk-ew065-gamma0825...')
resp = requests.post(
