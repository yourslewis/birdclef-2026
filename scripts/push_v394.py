"""Push v394 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v394-immediate-topk-ew0625-gamma0825-context025-k6'))
...
print('Pushing kernel v394-immediate-topk-ew0625-gamma0825-context025-k6...')
resp = requests.post(
