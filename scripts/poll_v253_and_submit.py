"""Poll v253 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v253-v245-context000"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v253: v245 smoothing + no file context boost"
