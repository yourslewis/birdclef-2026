"""Poll v380 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v380-ew0575-g080-ctx025-a045"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v380: immediate top-k + ProtoSSM EW0.575 + gamma 0.80 + context 0.25 + quantile alpha 0.45"
