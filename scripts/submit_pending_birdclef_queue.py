...
PENDING=[
    ...
    {"name":"v373","kernel":"yourslewis/bc26-v373-ew0575-g0825-ctx025-a0475","version":version,"message":"v373: immediate top-k + ProtoSSM EW0.575 + gamma 0.825 + context 0.25 + quantile alpha 0.475"},
    {"name":"v374","kernel":"yourslewis/bc26-v374-ew0575-g0825-ctx025-a0525","version":version,"message":"v374: immediate top-k + ProtoSSM EW0.575 + gamma 0.825 + context 0.25 + quantile alpha 0.525"},
    {"name":"v375","kernel":"yourslewis/bc26-v375-ew0575-g0825-ctx025-a045","version":version,"message":"v375: immediate top-k + ProtoSSM EW0.575 + gamma 0.825 + context 0.25 + quantile alpha 0.45"},
    {"name":"v500","kernel":"yourslewis/bc26-v500-sed-local-event-boost","version":version,"message":"v500: SED-inspired local event boost + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.20"},
    {"name":"v501","kernel":"yourslewis/bc26-v501-sed-local-ctx025","version":version,"message":"v501: conservative SED local event boost + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"},
    {"name":"v502","kernel":"yourslewis/bc26-v502-sed-local-top5","version":version,"message":"v502: SED local event boost top5 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"},
    ...
    {"name":"v514","kernel":"yourslewis/bc26-v514-real-sed-rankblend-005-2m","version":version,"message":"v514: real NFNet SED v13/v15 2-model per-class rank blend weight 0.05 + v508 axis"},
    ...
    {"name":"v525","kernel":"yourslewis/bc26-v525-taxon-max-gate-floor040","version":version,"message":"v525: Spec E higher-floor taxon max gate floor0.40 alpha0.75 + v508 axis"},
    ...
    {"name":"v541","kernel":"yourslewis/bc26-v541-public946-mirror-rare","version":version,"message":"v541: Public946 replay with sonotype mirroring + rare-taxon adaptive thresholding"},
    {"name":"v542","kernel":"yourslewis/bc26-v542-afr1ste-updated-public946","version":version,"message":"v542: Afr1ste updated public946 V8 Perch+SED replay"},
    ...
    {"name":"v537","kernel":"yourslewis/bc26-v537-v517-plus-oofteacher-b0-blend-002","version":version,"message":"v537: Spec B/A v517 taxon gate + fold-aware OOF-teacher B0 sidecar blend weight 0.02"},
    {"name":"v538","kernel":"yourslewis/bc26-v538-v517-plus-oofteacher-b0-blend-005","version":version,"message":"v538: Spec B/A v517 taxon gate + fold-aware OOF-teacher B0 sidecar blend weight 0.05"},
    {"name":"v528","kernel":"yourslewis/bc26-v528-v517-plus-v29-sed-blend-005","version":version,"message":"v528: Spec A/E v517 taxon gate + v29 broad 20s128 NFNet bundle blend weight 0.05"},
    {"name":"v529","kernel":"yourslewis/bc26-v529-v517-plus-v23v26-sed-blend-005","version":version,"message":"v529: Spec A/E v517 taxon gate + OOF-calibrated B0 v23/v26 SED blend weight 0.05"},
    ...
    {"name":"v379","kernel":"yourslewis/bc26-v379-ew0575-g0875-ctx025-a055","version":version,"message":"v379: immediate top-k + ProtoSSM EW0.575 + gamma 0.875 + context 0.25 + quantile alpha 0.55"},
    {"name":"v380","kernel":"yourslewis/bc26-v380-ew0575-g080-ctx025-a045","version":version,"message":"v380: immediate top-k + ProtoSSM EW0.575 + gamma 0.80 + context 0.25 + quantile alpha 0.45"},
    {"name":"v381","kernel":"yourslewis/bc26-v381-ew0575-g090-ctx025","version":version,"message":"v381: immediate top-k + ProtoSSM EW0.575 + gamma 0.90 + context 0.25"},
    {"name":"v382","kernel":"yourslewis/bc26-v382-ew0575-g090-ctx025-a055","version":version,"message":"v382: immediate top-k + ProtoSSM EW0.575 + gamma 0.90 + context 0.25 + quantile alpha 0.55"},
    {"name":"v383","kernel":"yourslewis/bc26-v383-ew0575-g090-ctx025-a045","version":version,"message":"v383: immediate top-k + ProtoSSM EW0.575 + gamma 0.90 + context 0.25 + quantile alpha 0.45"},
    {"name":"v384","kernel":"yourslewis/bc26-v384-ew0625-g080-ctx025","version":version,"message":"v384: immediate top-k + ProtoSSM EW0.625 + gamma 0.80 + context 0.25"},
    {"name":"v385","kernel":"yourslewis/bc26-v385-ew060-g080-ctx025","version":version,"message":"v385: immediate top-k + ProtoSSM EW0.60 + gamma 0.80 + context 0.25"},
    {"name":"v386","kernel":"yourslewis/bc26-v386-ew0625-g0875-ctx025","version":version,"message":"v386: immediate top-k + ProtoSSM EW0.625 + gamma 0.875 + context 0.25"},
    {"name":"v387","kernel":"yourslewis/bc26-v387-ew060-g0875-ctx025","version":version,"message":"v387: immediate top-k + ProtoSSM EW0.60 + gamma 0.875 + context 0.25"},
    {"name":"v388","kernel":"yourslewis/bc26-v388-ew0625-g0825-ctx025-a0525","version":version,"message":"v388: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context 0.25 + quantile alpha 0.525"},
    {"name":"v389","kernel":"yourslewis/bc26-v389-ew0625-g0825-ctx025-a0475","version":version,"message":"v389: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context 0.25 + quantile alpha 0.475"},
    {"name":"v390","kernel":"yourslewis/bc26-v390-ew0625-g0825-ctx025-a055","version":version,"message":"v390: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context 0.25 + quantile alpha 0.55"},
    {"name":"v391","kernel":"yourslewis/bc26-v391-ew0625-g0825-ctx025-a045","version":version,"message":"v391: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context 0.25 + quantile alpha 0.45"},
    {"name":"v392","kernel":"yourslewis/bc26-v392-ew0625-g0825-ctx025-k3","version":version,"message":"v392: immediate top-k K=3 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v393","kernel":"yourslewis/bc26-v393-ew0625-g0825-ctx025-k4","version":version,"message":"v393: immediate top-k K=4 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v394","kernel":"yourslewis/bc26-v394-ew0625-g0825-ctx025-k6","version":version,"message":"v394: immediate top-k K=6 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v395","kernel":"yourslewis/bc26-v395-ew0625-g0825-ctx025-k7","version":version,"message":"v395: immediate top-k K=7 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v396","kernel":"yourslewis/bc26-v396-ew0625-g0825-ctx025-k8","version":version,"message":"v396: immediate top-k K=8 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v397","kernel":"yourslewis/bc26-v397-ew0625-g0825-ctx025-k2","version":version,"message":"v397: immediate top-k K=2 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v398","kernel":"yourslewis/bc26-v398-ew0625-g0825-ctx025-p085115","version":version,"message":"v398: immediate top-k strong contrast p0.85/1.15 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    {"name":"v399","kernel":"yourslewis/bc26-v399-ew0625-g0825-ctx025-p085100","version":version,"message":"v399: immediate top-k boost-only p0.85/1.00 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"},
    ...
    {"name":"v404","kernel":"yourslewis/bc26-v404-ew06125-g0825-ctx025","version":version,"message":"v404: immediate top-k + ProtoSSM EW0.6125 + gamma 0.825 + context alpha 0.25"},
    {"name":"v405","kernel":"yourslewis/bc26-v405-ew06375-g0825-ctx025","version":version,"message":"v405: immediate top-k + ProtoSSM EW0.6375 + gamma 0.825 + context alpha 0.25"},
    {"name":"v406","kernel":"yourslewis/bc26-v406-ew05875-g0825-ctx025","version":version,"message":"v406: immediate top-k + ProtoSSM EW0.5875 + gamma 0.825 + context alpha 0.25"},
    {"name":"v407","kernel":"yourslewis/bc26-v407-ew0625-g08125-ctx025","version":version,"message":"v407: immediate top-k + ProtoSSM EW0.625 + gamma 0.8125 + context alpha 0.25"},
    {"name":"v408","kernel":"yourslewis/bc26-v408-ew0625-g08375-ctx025","version":version,"message":"v408: immediate top-k + ProtoSSM EW0.625 + gamma 0.8375 + context alpha 0.25"},
    {"name":"v409","kernel":"yourslewis/bc26-v409-ew0625-g0825-ctx0275","version":version,"message":"v409: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.275"},
    {"name":"v410","kernel":"yourslewis/bc26-v410-ew0625-g0825-ctx02375","version":version,"message":"v410: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.2375"},
    {"name":"v411","kernel":"yourslewis/bc26-v411-ew0625-g0825-ctx02625","version":version,"message":"v411: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.2625"},
    {"name":"v412","kernel":"yourslewis/bc26-v412-ew0625-g0825-ctx025625","version":version,"message":"v412: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25625"},
    {"name":"v413","kernel":"yourslewis/bc26-v413-ew0625-g0825-ctx0253125","version":version,"message":"v413: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.253125"},
    {"name":"v414","kernel":"yourslewis/bc26-v414-ew0625-g0825-ctx02515625","version":version,"message":"v414: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.2515625"},
    {"name":"v415","kernel":"yourslewis/bc26-v415-ew0625-g0825-ctx025078125","version":version,"message":"v415: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25078125"},
    {"name":"v416","kernel":"yourslewis/bc26-v416-ew0625-g0825-ctx024921875","version":version,"message":"v416: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.24921875"},
    {"name":"v417","kernel":"yourslewis/bc26-v417-ew0625-g0825-ctx025-a0505","version":version,"message":"v417: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.505"},
    {"name":"v418","kernel":"yourslewis/bc26-v418-ew0625-g0825-ctx025-a0495","version":version,"message":"v418: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.495"},
    {"name":"v419","kernel":"yourslewis/bc26-v419-ew0625-g0825-ctx025-a05025","version":version,"message":"v419: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.5025"},
    {"name":"v420","kernel":"yourslewis/bc26-v420-ew0625-g0825-ctx025-a050125","version":version,"message":"v420: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.50125"},
    {"name":"v421","kernel":"yourslewis/bc26-v421-ew0625-g0825-ctx025-a049875","version":version,"message":"v421: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.49875"},
    {"name":"v422","kernel":"yourslewis/bc26-v422-ew0625-g0825-ctx025-a0500625","version":version,"message":"v422: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.500625"},
    {"name":"v423","kernel":"yourslewis/bc26-v423-ew0625-g0825-ctx025-a0499375","version":version,"message":"v423: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25 + quantile alpha 0.499375"},
...
FOCUS_PRIORITY_NAMES = ["v516", "v517", "v523", "v524", "v525", "v518", "v519", "v520", "v521", "v522", "v526", "v539", "v541", "v542", "v527", "v531", "v532", "v537", "v538"]
