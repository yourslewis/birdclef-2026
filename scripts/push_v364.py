"""Push v364 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v364-immediate-topk-ew0675-gamma0825-context0275'))
...
print('Pushing kernel v364-immediate-topk-ew0675-gamma0825-context0275...')
resp = requests.post(
