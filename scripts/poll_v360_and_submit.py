"""Poll v360 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v360-immediate-topk-ew065-gamma080"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v360: immediate top-k + ProtoSSM EW0.65 + power gamma 0.80"
