"""Push v350 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v350-immediate-topk-ew060-gamma0875'))
...
print('Pushing kernel v350-immediate-topk-ew060-gamma0875...')
resp = requests.post(
