"""Push v360 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v360-immediate-topk-ew065-gamma080'))
...
print('Pushing kernel v360-immediate-topk-ew065-gamma080...')
resp = requests.post(
