"""Poll v355 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v355-immediate-topk-ew0625-gamma090"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v355: immediate top-k + ProtoSSM EW0.625 + power gamma 0.90"
