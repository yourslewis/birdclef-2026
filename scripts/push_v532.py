"""Push v532 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v532-v517-v29-onnx3-blend005'))
...
print('Pushing kernel v532-v517-v29-onnx3-blend005...')
