"""Poll v400 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v400-ew0625-g0825-ctx025-p100115"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v400: immediate top-k damp-only p1.00/1.15 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
