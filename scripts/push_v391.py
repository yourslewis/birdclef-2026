"""Push v391 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v391-immediate-topk-ew0625-gamma0825-context025-alpha045'))
...
print('Pushing kernel v391-immediate-topk-ew0625-gamma0825-context025-alpha045...')
resp = requests.post(
