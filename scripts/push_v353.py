"""Push v353 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v353-immediate-topk-ew0625-gamma0825'))
...
print('Pushing kernel v353-immediate-topk-ew0625-gamma0825...')
resp = requests.post(
