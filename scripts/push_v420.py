"""Push v420 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v420-immediate-topk-ew0625-gamma0825-context025-alpha050125'))
...
print('Pushing kernel v420-immediate-topk-ew0625-gamma0825-context025-alpha050125...')
resp = requests.post(
