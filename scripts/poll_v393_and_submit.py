"""Poll v393 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v393-ew0625-g0825-ctx025-k4"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v393: immediate top-k K=4 + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
