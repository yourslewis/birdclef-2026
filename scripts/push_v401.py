"""Push v401 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v401-immediate-topk-ew0625-gamma0825-context025-mild-contrast'))
...
print('Pushing kernel v401-immediate-topk-ew0625-gamma0825-context025-mild-contrast...')
resp = requests.post(
