"""Push v521 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v521-sed-b0-ep12init-v23-blend010'))
...
print('Pushing kernel v521-sed-b0-ep12init-v23-blend010...')
