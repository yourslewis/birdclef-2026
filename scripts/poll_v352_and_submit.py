"""Poll v352 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v352-immediate-topk-ew060-gamma080"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v352: immediate top-k + ProtoSSM EW0.60 + power gamma 0.80"
