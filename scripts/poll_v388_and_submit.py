"""Poll v388 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v388-ew0625-g0825-ctx025-a0525"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v388: immediate top-k + ProtoSSM EW0.625 + gamma 0.825 + context 0.25 + quantile alpha 0.525"
