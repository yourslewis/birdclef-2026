"""Poll v349 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v349-immediate-topk-ew060-gamma0825"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v349: immediate top-k + ProtoSSM EW0.60 + power gamma 0.825"
