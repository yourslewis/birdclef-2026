"""Push v504 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v504-sed-local-logit-top3'))
...
print('Pushing kernel v504-sed-local-logit-top3...')
resp = requests.post(
