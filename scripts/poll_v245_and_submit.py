"""Poll v245 and submit completed kernel version to BirdCLEF 2026."""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v245-sharp-temporal-smoothing"
...
while True:
    ...
    if "COMPLETE" in status_text or "complete" in status_text.lower():
        ...
        res = api.competition_submit_code(
            ...
            message="v245: v238 + sharper Gaussian temporal smoothing",
