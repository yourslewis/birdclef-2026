"""Push v518 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v518-student-b0-5s-blend002'))
...
print('Pushing kernel v518-student-b0-5s-blend002...')
