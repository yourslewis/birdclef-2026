...
def main() -> int:
    ...
    for cand in CANDIDATES:
        ...
        if cand.description in existing_desc:
            ...
            continue
        if args.submit and submitted >= args.max_submissions:
            print(f"stop: reached --max-submissions={args.max_submissions}")
            break
        if not args.submit and would_submit >= args.max_submissions:
            print(f"dry-run stop: reached --max-submissions={args.max_submissions}")
            break
        try:
