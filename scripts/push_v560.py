"""Push v560 public946 + direct V2S student rank 3% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v560-public946-direct-v2s-r003'))
...
print('Pushing kernel v560-public946-direct-v2s-r003...')
resp = requests.post(
