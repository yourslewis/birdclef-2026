"""Poll v501 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v501-sed-local-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v501: conservative SED local event boost + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"
