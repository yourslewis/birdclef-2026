"""Push v607 Eslam v26C ProtoSSM save repair verification kernel via Bearer API v1."""
import json, os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v607-eslam-v26c-proto-save'))
...
print('Pushing v607 Eslam v26C ProtoSSM save kernel...')
resp = requests.post(
