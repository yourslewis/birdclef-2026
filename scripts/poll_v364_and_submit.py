"""Poll v364 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v364-ew0675-g0825-ctx0275"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v364: immediate top-k + ProtoSSM EW0.675 + gamma 0.825 + context alpha 0.275"
