"""Poll v371 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v371-ew0575-g080-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v371: immediate top-k + ProtoSSM EW0.575 + gamma 0.80 + context alpha 0.25"
