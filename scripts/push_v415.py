"""Push v415 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v415-immediate-topk-ew0625-gamma0825-context025078125'))
...
print('Pushing kernel v415-immediate-topk-ew0625-gamma0825-context025078125...')
resp = requests.post(
