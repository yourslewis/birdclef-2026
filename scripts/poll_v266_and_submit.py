"""Poll v266 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v266-v245-gamma0825"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v266: v245 smoothing + power gamma 0.825"
