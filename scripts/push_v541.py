"""Push v541 public946 mirror/rare Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v541-public946-mirror-rare'))
...
print('Pushing kernel v541-public946-mirror-rare...')
resp = requests.post(
