"""Poll v385 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v385-ew060-g080-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v385: immediate top-k + ProtoSSM EW0.60 + gamma 0.80 + context 0.25"
