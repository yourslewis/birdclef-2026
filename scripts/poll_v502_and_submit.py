"""Poll v502 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v502-sed-local-top5"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v502: SED local event boost top5 + ProtoSSM EW0.625 + gamma 0.825 + context alpha 0.25"
