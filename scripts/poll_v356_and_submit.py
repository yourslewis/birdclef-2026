"""Poll v356 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v356-immediate-topk-ew0625-gamma080"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v356: immediate top-k + ProtoSSM EW0.625 + power gamma 0.80"
