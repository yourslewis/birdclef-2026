"""Push v421 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v421-immediate-topk-ew0625-gamma0825-context025-alpha049875'))
...
print('Pushing kernel v421-immediate-topk-ew0625-gamma0825-context025-alpha049875...')
resp = requests.post(
