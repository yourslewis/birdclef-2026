"""Poll v402 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v402-ew0625-g0825-ctx025-notopk"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v402: immediate no top-k contrast + ProtoSSM EW0.625 + gamma 0.825 + context 0.25"
