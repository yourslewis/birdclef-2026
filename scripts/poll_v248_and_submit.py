"""Poll v248 and submit completed kernel version to BirdCLEF 2026.

If Kaggle's daily code-submission allowance is exhausted, keep the monitor alive
and retry periodically instead of disappearing silently.
"""
import json
import os
import time
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v248-v245-gamma080"
