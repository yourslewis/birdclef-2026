"""Push v516 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v516-taxon-max-gate'))
...
print('Pushing kernel v516-taxon-max-gate...')
