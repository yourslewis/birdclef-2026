"""Push v509 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v509-nocall-confidence-gate'))
...
print('Pushing kernel v509-nocall-confidence-gate...')
resp = requests.post(
