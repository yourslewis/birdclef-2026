"""Push v371 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v371-immediate-topk-ew0575-gamma080-context025'))
...
print('Pushing kernel v371-immediate-topk-ew0575-gamma080-context025...')
resp = requests.post(
