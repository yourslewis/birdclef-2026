"""Push v610 Gandharva B3 checkpoint inference verifier via Kaggle Bearer API."""
import json, os
from pathlib import Path
import requests
FOLDER=Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v610-gandharva-b3-infer'))
