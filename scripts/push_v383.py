"""Push v383 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v383-immediate-topk-ew0575-gamma090-context025-alpha045'))
...
print('Pushing kernel v383-immediate-topk-ew0575-gamma090-context025-alpha045...')
resp = requests.post(
