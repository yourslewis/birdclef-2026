"""Push v556 low-displacement public946 gate-retune Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v556-public946-gateretune-a010'))
...
print('Pushing kernel v556-public946-gateretune-a010...')
resp = requests.post(
