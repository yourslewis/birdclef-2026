"""Push v366 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v366-immediate-topk-ew055-gamma0825-context025'))
...
print('Pushing kernel v366-immediate-topk-ew055-gamma0825-context025...')
resp = requests.post(
