"""Push v409 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v409-immediate-topk-ew0625-gamma0825-context0275'))
...
print('Pushing kernel v409-immediate-topk-ew0625-gamma0825-context0275...')
resp = requests.post(
