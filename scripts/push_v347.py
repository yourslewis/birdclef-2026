"""Push v347 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v347-immediate-topk-ew055-gamma080'))
...
print('Pushing kernel v347-immediate-topk-ew055-gamma080...')
resp = requests.post(
