"""Push v380 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v380-immediate-topk-ew0575-gamma080-context025-alpha045'))
...
print('Pushing kernel v380-immediate-topk-ew0575-gamma080-context025-alpha045...')
resp = requests.post(
