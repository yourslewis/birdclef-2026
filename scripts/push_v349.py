"""Push v349 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v349-immediate-topk-ew060-gamma0825'))
...
print('Pushing kernel v349-immediate-topk-ew060-gamma0825...')
resp = requests.post(
