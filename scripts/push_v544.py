"""Push v544 Public946 BirdNET 5% Kaggle kernel with Bearer auth."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v544-public946-birdnet05'))
...
print('Pushing kernel v544-public946-birdnet05...')
resp = requests.post(
