"""Push v396 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
...
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v396-immediate-topk-ew0625-gamma0825-context025-k8'))
...
print('Pushing kernel v396-immediate-topk-ew0625-gamma0825-context025-k8...')
resp = requests.post(
