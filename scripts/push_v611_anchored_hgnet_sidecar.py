"""Push v611 anchored HGNet sidecar private validation kernel via Kaggle Bearer API."""
import json
import os
...
FOLDER = Path(__file__).resolve().parents[1] / "kaggle-kernels" / "v611-anchored-hgnet-sidecar"
