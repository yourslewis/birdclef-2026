"""Push v517 Kaggle kernel with KGAT Bearer auth via Kaggle API v1."""
import json
import os
from pathlib import Path
import requests
FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026/kaggle-kernels/v517-taxon-max-gate-alpha050'))
...
print('Pushing kernel v517-taxon-max-gate-alpha050...')
