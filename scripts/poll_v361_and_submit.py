"""Poll v361 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v361-immediate-topk-ew0675-gamma0825"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v361: immediate top-k + ProtoSSM EW0.675 + power gamma 0.825"
