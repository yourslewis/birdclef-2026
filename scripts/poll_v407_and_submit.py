"""Poll v407 and submit completed kernel version to BirdCLEF 2026."""
...
slug="yourslewis/bc26-v407-ew0625-g08125-ctx025"
kernel_version=int(os.environ.get("KAGGLE_KERNEL_VERSION","1"))
message="v407: immediate top-k + ProtoSSM EW0.625 + gamma 0.8125 + context alpha 0.25"
