"""Poll v258 and submit completed kernel version to BirdCLEF 2026.
...
api = KaggleApi()
api.authenticate()
slug = "yourslewis/birdclef-2026-v258-v245-strong-tail-damp"
kernel_version = int(os.environ.get("KAGGLE_KERNEL_VERSION", "1"))
message = "v258: v245 smoothing + stronger low-rank tail dampening"
