"""Push v554 public946 gate-retune Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v554-public946-gateretune-pw056'))
...
print('Pushing kernel v554-public946-gateretune-pw056...')
resp = requests.post(
