"""Push v598 Samejima HGNet OpenVINO artifact kernel via Kaggle Bearer API."""
import json, os
from pathlib import Path
import requests
FOLDER=Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v598-samejima-hgnet-openvino-artifact'))
