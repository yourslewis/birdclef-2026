"""Push v548 public946 + CV9245 0.5% Kaggle kernel with Bearer API v1."""
import json
import os
from pathlib import Path
import requests

FOLDER = Path(os.path.expanduser('~/Documents/birdclef-2026-v545/kaggle-kernels/v548-public946-cv9245-w0005'))
...
print('Pushing kernel v548-public946-cv9245-w0005...')
resp = requests.post(
